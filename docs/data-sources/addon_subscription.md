...
&#x2022; `name` - Required String<br>Name of the AddonSubscription

&#x2022; `namespace` - Required String<br>Namespace where the AddonSubscription exists
...
&#x2022; `description` - Optional String<br>Description of the AddonSubscription
