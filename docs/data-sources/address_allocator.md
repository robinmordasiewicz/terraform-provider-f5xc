...
&#x2022; `name` - Required String<br>Name of the AddressAllocator

&#x2022; `namespace` - Required String<br>Namespace where the AddressAllocator exists
...
&#x2022; `description` - Optional String<br>Description of the AddressAllocator
