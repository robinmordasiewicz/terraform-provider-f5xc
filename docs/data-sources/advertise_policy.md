...
&#x2022; `name` - Required String<br>Name of the AdvertisePolicy

&#x2022; `namespace` - Required String<br>Namespace where the AdvertisePolicy exists
...
&#x2022; `description` - Optional String<br>Description of the AdvertisePolicy
