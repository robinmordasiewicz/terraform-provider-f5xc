...
&#x2022; `name` - Required String<br>Name of the AlertReceiver

&#x2022; `namespace` - Required String<br>Namespace where the AlertReceiver exists
...
&#x2022; `description` - Optional String<br>Description of the AlertReceiver
