...
&#x2022; `name` - Required String<br>Name of the AllowedTenant

&#x2022; `namespace` - Required String<br>Namespace where the AllowedTenant exists
...
&#x2022; `description` - Optional String<br>Description of the AllowedTenant
