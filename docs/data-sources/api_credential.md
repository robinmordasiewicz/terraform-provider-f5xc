...
&#x2022; `name` - Required String<br>Name of the APICredential

&#x2022; `namespace` - Required String<br>Namespace where the APICredential exists
...
&#x2022; `description` - Optional String<br>Description of the APICredential
