...
&#x2022; `name` - Required String<br>Name of the APIDefinition

&#x2022; `namespace` - Required String<br>Namespace where the APIDefinition exists
...
&#x2022; `description` - Optional String<br>Description of the APIDefinition
