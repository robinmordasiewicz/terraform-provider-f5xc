...
&#x2022; `name` - Required String<br>Name of the APITesting

&#x2022; `namespace` - Required String<br>Namespace where the APITesting exists
...
&#x2022; `description` - Optional String<br>Description of the APITesting
