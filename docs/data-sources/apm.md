...
&#x2022; `name` - Required String<br>Name of the APM

&#x2022; `namespace` - Required String<br>Namespace where the APM exists
...
&#x2022; `description` - Optional String<br>Description of the APM
