...
&#x2022; `name` - Required String<br>Name of the AppAPIGroup

&#x2022; `namespace` - Required String<br>Namespace where the AppAPIGroup exists
...
&#x2022; `description` - Optional String<br>Description of the AppAPIGroup
