...
`name` - (Required) Name of the AppFirewall (`String`).

`namespace` - (Required) Namespace where the AppFirewall exists (`String`).
...
`description` - (Optional) Description of the AppFirewall (`String`).
