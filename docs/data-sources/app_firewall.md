...
&#x2022; `name` - Required String<br>Name of the AppFirewall

&#x2022; `namespace` - Required String<br>Namespace where the AppFirewall exists
...
&#x2022; `description` - Optional String<br>Description of the AppFirewall
