...
&#x2022; `name` - Required String<br>Name of the AWSTGWSite

&#x2022; `namespace` - Required String<br>Namespace where the AWSTGWSite exists
...
&#x2022; `description` - Optional String<br>Description of the AWSTGWSite
