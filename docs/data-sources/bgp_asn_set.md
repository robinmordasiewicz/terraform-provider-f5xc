...
&#x2022; `name` - Required String<br>Name of the BGPAsnSet

&#x2022; `namespace` - Required String<br>Namespace where the BGPAsnSet exists
...
&#x2022; `description` - Optional String<br>Description of the BGPAsnSet
