...
&#x2022; `name` - Required String<br>Name of the BGPRoutingPolicy

&#x2022; `namespace` - Required String<br>Namespace where the BGPRoutingPolicy exists
...
&#x2022; `description` - Optional String<br>Description of the BGPRoutingPolicy
