...
&#x2022; `name` - Required String<br>Name of the BigIPIrule

&#x2022; `namespace` - Required String<br>Namespace where the BigIPIrule exists
...
&#x2022; `description` - Optional String<br>Description of the BigIPIrule
