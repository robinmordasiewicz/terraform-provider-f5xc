...
&#x2022; `name` - Required String<br>Name of the CDNCacheRule

&#x2022; `namespace` - Required String<br>Namespace where the CDNCacheRule exists
...
&#x2022; `description` - Optional String<br>Description of the CDNCacheRule
