...
&#x2022; `name` - Required String<br>Name of the Certificate

&#x2022; `namespace` - Required String<br>Namespace where the Certificate exists
...
&#x2022; `description` - Optional String<br>Description of the Certificate
