...
&#x2022; `name` - Required String<br>Name of the CertificateChain

&#x2022; `namespace` - Required String<br>Namespace where the CertificateChain exists
...
&#x2022; `description` - Optional String<br>Description of the CertificateChain
