...
&#x2022; `name` - Required String<br>Name of the ChildTenantManager

&#x2022; `namespace` - Required String<br>Namespace where the ChildTenantManager exists
...
&#x2022; `description` - Optional String<br>Description of the ChildTenantManager
