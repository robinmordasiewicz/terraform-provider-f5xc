...
&#x2022; `name` - Required String<br>Name of the CloudCredentials

&#x2022; `namespace` - Required String<br>Namespace where the CloudCredentials exists
...
&#x2022; `description` - Optional String<br>Description of the CloudCredentials
