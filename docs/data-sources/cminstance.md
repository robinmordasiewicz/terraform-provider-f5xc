...
&#x2022; `name` - Required String<br>Name of the Cminstance

&#x2022; `namespace` - Required String<br>Namespace where the Cminstance exists
...
&#x2022; `description` - Optional String<br>Description of the Cminstance
