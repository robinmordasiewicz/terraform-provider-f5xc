...
&#x2022; `name` - Required String<br>Name of the CodeBaseIntegration

&#x2022; `namespace` - Required String<br>Namespace where the CodeBaseIntegration exists
...
&#x2022; `description` - Optional String<br>Description of the CodeBaseIntegration
