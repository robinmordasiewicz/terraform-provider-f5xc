...
&#x2022; `name` - Required String<br>Name of the Contact

&#x2022; `namespace` - Required String<br>Namespace where the Contact exists
...
&#x2022; `description` - Optional String<br>Description of the Contact
