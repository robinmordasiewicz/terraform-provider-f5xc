...
&#x2022; `name` - Required String<br>Name of the DataGroup

&#x2022; `namespace` - Required String<br>Namespace where the DataGroup exists
...
&#x2022; `description` - Optional String<br>Description of the DataGroup
