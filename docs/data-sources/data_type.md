...
&#x2022; `name` - Required String<br>Name of the DataType

&#x2022; `namespace` - Required String<br>Namespace where the DataType exists
...
&#x2022; `description` - Optional String<br>Description of the DataType
