...
&#x2022; `name` - Required String<br>Name of the DNSLbHealthCheck

&#x2022; `namespace` - Required String<br>Namespace where the DNSLbHealthCheck exists
...
&#x2022; `description` - Optional String<br>Description of the DNSLbHealthCheck
