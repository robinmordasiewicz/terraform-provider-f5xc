...
&#x2022; `name` - Required String<br>Name of the DNSLbPool

&#x2022; `namespace` - Required String<br>Namespace where the DNSLbPool exists
...
&#x2022; `description` - Optional String<br>Description of the DNSLbPool
