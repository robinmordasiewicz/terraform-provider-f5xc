...
&#x2022; `name` - Required String<br>Name of the DNSLoadBalancer

&#x2022; `namespace` - Required String<br>Namespace where the DNSLoadBalancer exists
...
&#x2022; `description` - Optional String<br>Description of the DNSLoadBalancer
