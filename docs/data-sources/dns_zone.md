...
&#x2022; `name` - Required String<br>Name of the DNSZone

&#x2022; `namespace` - Required String<br>Namespace where the DNSZone exists
...
&#x2022; `description` - Optional String<br>Description of the DNSZone
