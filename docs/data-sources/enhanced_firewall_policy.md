...
&#x2022; `name` - Required String<br>Name of the EnhancedFirewallPolicy

&#x2022; `namespace` - Required String<br>Namespace where the EnhancedFirewallPolicy exists
...
&#x2022; `description` - Optional String<br>Description of the EnhancedFirewallPolicy
