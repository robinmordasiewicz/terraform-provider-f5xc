...
&#x2022; `name` - Required String<br>Name of the FastACL

&#x2022; `namespace` - Required String<br>Namespace where the FastACL exists
...
&#x2022; `description` - Optional String<br>Description of the FastACL
