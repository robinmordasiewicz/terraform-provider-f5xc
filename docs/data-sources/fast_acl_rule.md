...
&#x2022; `name` - Required String<br>Name of the FastACLRule

&#x2022; `namespace` - Required String<br>Namespace where the FastACLRule exists
...
&#x2022; `description` - Optional String<br>Description of the FastACLRule
