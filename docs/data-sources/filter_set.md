...
&#x2022; `name` - Required String<br>Name of the FilterSet

&#x2022; `namespace` - Required String<br>Namespace where the FilterSet exists
...
&#x2022; `description` - Optional String<br>Description of the FilterSet
