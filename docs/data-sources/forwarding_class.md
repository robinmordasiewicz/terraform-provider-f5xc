...
&#x2022; `name` - Required String<br>Name of the ForwardingClass

&#x2022; `namespace` - Required String<br>Namespace where the ForwardingClass exists
...
&#x2022; `description` - Optional String<br>Description of the ForwardingClass
