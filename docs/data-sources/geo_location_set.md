...
&#x2022; `name` - Required String<br>Name of the GeoLocationSet

&#x2022; `namespace` - Required String<br>Namespace where the GeoLocationSet exists
...
&#x2022; `description` - Optional String<br>Description of the GeoLocationSet
