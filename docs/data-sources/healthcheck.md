...
&#x2022; `name` - Required String<br>Name of the Healthcheck

&#x2022; `namespace` - Required String<br>Namespace where the Healthcheck exists
...
&#x2022; `description` - Optional String<br>Description of the Healthcheck
