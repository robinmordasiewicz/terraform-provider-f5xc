...
&#x2022; `name` - Required String<br>Name of the HTTPLoadBalancer

&#x2022; `namespace` - Required String<br>Namespace where the HTTPLoadBalancer exists
...
&#x2022; `description` - Optional String<br>Description of the HTTPLoadBalancer
