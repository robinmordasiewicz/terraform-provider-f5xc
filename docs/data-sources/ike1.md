...
&#x2022; `name` - Required String<br>Name of the Ike1

&#x2022; `namespace` - Required String<br>Namespace where the Ike1 exists
...
&#x2022; `description` - Optional String<br>Description of the Ike1
