...
&#x2022; `name` - Required String<br>Name of the IKEPhase1Profile

&#x2022; `namespace` - Required String<br>Namespace where the IKEPhase1Profile exists
...
&#x2022; `description` - Optional String<br>Description of the IKEPhase1Profile
