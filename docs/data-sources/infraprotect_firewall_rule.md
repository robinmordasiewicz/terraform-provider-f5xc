...
&#x2022; `name` - Required String<br>Name of the InfraprotectFirewallRule

&#x2022; `namespace` - Required String<br>Namespace where the InfraprotectFirewallRule exists
...
&#x2022; `description` - Optional String<br>Description of the InfraprotectFirewallRule
