...
&#x2022; `name` - Required String<br>Name of the InfraprotectInternetPrefixAdvertisement

&#x2022; `namespace` - Required String<br>Namespace where the InfraprotectInternetPrefixAdvertisement exists
...
&#x2022; `description` - Optional String<br>Description of the InfraprotectInternetPrefixAdvertisement
