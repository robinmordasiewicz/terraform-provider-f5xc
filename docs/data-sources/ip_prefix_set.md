...
&#x2022; `name` - Required String<br>Name of the IPPrefixSet

&#x2022; `namespace` - Required String<br>Namespace where the IPPrefixSet exists
...
&#x2022; `description` - Optional String<br>Description of the IPPrefixSet
