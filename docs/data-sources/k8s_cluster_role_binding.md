...
`name` - (Required) Name of the K8SClusterRoleBinding (`String`).

`namespace` - (Required) Namespace where the K8SClusterRoleBinding exists (`String`).
...
`description` - (Optional) Description of the K8SClusterRoleBinding (`String`).
