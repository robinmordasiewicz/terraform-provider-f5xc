...
&#x2022; `name` - Required String<br>Name of the K8SPodSecurityAdmission

&#x2022; `namespace` - Required String<br>Namespace where the K8SPodSecurityAdmission exists
...
&#x2022; `description` - Optional String<br>Description of the K8SPodSecurityAdmission
