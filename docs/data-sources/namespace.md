...
&#x2022; `name` - Required String<br>Name of the Namespace

&#x2022; `namespace` - Required String<br>Namespace where the Namespace exists
...
&#x2022; `description` - Optional String<br>Description of the Namespace
