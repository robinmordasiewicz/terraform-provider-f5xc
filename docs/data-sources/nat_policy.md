...
&#x2022; `name` - Required String<br>Name of the NatPolicy

&#x2022; `namespace` - Required String<br>Namespace where the NatPolicy exists
...
&#x2022; `description` - Optional String<br>Description of the NatPolicy
