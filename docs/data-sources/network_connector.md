...
&#x2022; `name` - Required String<br>Name of the NetworkConnector

&#x2022; `namespace` - Required String<br>Namespace where the NetworkConnector exists
...
&#x2022; `description` - Optional String<br>Description of the NetworkConnector
