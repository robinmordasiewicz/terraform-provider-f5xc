...
&#x2022; `name` - Required String<br>Name of the NetworkFirewall

&#x2022; `namespace` - Required String<br>Namespace where the NetworkFirewall exists
...
&#x2022; `description` - Optional String<br>Description of the NetworkFirewall
