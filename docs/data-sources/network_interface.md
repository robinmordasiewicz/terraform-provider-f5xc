...
&#x2022; `name` - Required String<br>Name of the NetworkInterface

&#x2022; `namespace` - Required String<br>Namespace where the NetworkInterface exists
...
&#x2022; `description` - Optional String<br>Description of the NetworkInterface
