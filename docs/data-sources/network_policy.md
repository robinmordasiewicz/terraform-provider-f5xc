...
&#x2022; `name` - Required String<br>Name of the NetworkPolicy

&#x2022; `namespace` - Required String<br>Namespace where the NetworkPolicy exists
...
&#x2022; `description` - Optional String<br>Description of the NetworkPolicy
