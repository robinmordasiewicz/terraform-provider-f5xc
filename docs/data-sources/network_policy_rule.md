...
&#x2022; `name` - Required String<br>Name of the NetworkPolicyRule

&#x2022; `namespace` - Required String<br>Namespace where the NetworkPolicyRule exists
...
&#x2022; `description` - Optional String<br>Description of the NetworkPolicyRule
