...
&#x2022; `name` - Required String<br>Name of the NetworkPolicyView

&#x2022; `namespace` - Required String<br>Namespace where the NetworkPolicyView exists
...
&#x2022; `description` - Optional String<br>Description of the NetworkPolicyView
