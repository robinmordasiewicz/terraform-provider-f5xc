...
`name` - (Required) Name of the NFVService (`String`).

`namespace` - (Required) Namespace where the NFVService exists (`String`).
...
`description` - (Optional) Description of the NFVService (`String`).
