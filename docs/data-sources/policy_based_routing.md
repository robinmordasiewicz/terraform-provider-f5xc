...
&#x2022; `name` - Required String<br>Name of the PolicyBasedRouting

&#x2022; `namespace` - Required String<br>Namespace where the PolicyBasedRouting exists
...
&#x2022; `description` - Optional String<br>Description of the PolicyBasedRouting
