...
&#x2022; [`name`](#name) - Required String<br>Name of the ProtocolInspection

&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the ProtocolInspection exists
...
&#x2022; [`description`](#description) - Optional String<br>Description of the ProtocolInspection
