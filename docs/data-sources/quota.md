...
&#x2022; `name` - Required String<br>Name of the Quota

&#x2022; `namespace` - Required String<br>Namespace where the Quota exists
...
&#x2022; `description` - Optional String<br>Description of the Quota
