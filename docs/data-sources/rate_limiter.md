...
&#x2022; `name` - Required String<br>Name of the RateLimiter

&#x2022; `namespace` - Required String<br>Namespace where the RateLimiter exists
...
&#x2022; `description` - Optional String<br>Description of the RateLimiter
