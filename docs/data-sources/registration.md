...
&#x2022; `name` - Required String<br>Name of the Registration

&#x2022; `namespace` - Required String<br>Namespace where the Registration exists
...
&#x2022; `description` - Optional String<br>Description of the Registration
