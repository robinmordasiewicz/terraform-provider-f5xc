...
&#x2022; [`name`](#name) - Required String<br>Name of the ReportConfig

&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the ReportConfig exists
...
&#x2022; [`description`](#description) - Optional String<br>Description of the ReportConfig
