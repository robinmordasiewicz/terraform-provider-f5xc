...
&#x2022; `name` - Required String<br>Name of the Route

&#x2022; `namespace` - Required String<br>Namespace where the Route exists
...
&#x2022; `description` - Optional String<br>Description of the Route
