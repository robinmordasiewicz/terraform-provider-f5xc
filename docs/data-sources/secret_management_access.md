...
&#x2022; `name` - Required String<br>Name of the SecretManagementAccess

&#x2022; `namespace` - Required String<br>Namespace where the SecretManagementAccess exists
...
&#x2022; `description` - Optional String<br>Description of the SecretManagementAccess
