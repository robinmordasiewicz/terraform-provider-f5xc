...
&#x2022; `name` - Required String<br>Name of the SecretPolicy

&#x2022; `namespace` - Required String<br>Namespace where the SecretPolicy exists
...
&#x2022; `description` - Optional String<br>Description of the SecretPolicy
