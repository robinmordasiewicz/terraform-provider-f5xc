...
&#x2022; `name` - Required String<br>Name of the SecuremeshSite

&#x2022; `namespace` - Required String<br>Namespace where the SecuremeshSite exists
...
&#x2022; `description` - Optional String<br>Description of the SecuremeshSite
