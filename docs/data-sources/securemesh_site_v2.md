...
&#x2022; `name` - Required String<br>Name of the SecuremeshSiteV2

&#x2022; `namespace` - Required String<br>Namespace where the SecuremeshSiteV2 exists
...
&#x2022; `description` - Optional String<br>Description of the SecuremeshSiteV2
