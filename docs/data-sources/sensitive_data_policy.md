...
&#x2022; `name` - Required String<br>Name of the SensitiveDataPolicy

&#x2022; `namespace` - Required String<br>Namespace where the SensitiveDataPolicy exists
...
&#x2022; `description` - Optional String<br>Description of the SensitiveDataPolicy
