...
`name` - (Required) Name of the ServicePolicy (`String`).

`namespace` - (Required) Namespace where the ServicePolicy exists (`String`).
...
`description` - (Optional) Description of the ServicePolicy (`String`).
