...
&#x2022; `name` - Required String<br>Name of the ServicePolicy

&#x2022; `namespace` - Required String<br>Namespace where the ServicePolicy exists
...
&#x2022; `description` - Optional String<br>Description of the ServicePolicy
