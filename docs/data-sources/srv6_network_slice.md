...
&#x2022; `name` - Required String<br>Name of the Srv6NetworkSlice

&#x2022; `namespace` - Required String<br>Namespace where the Srv6NetworkSlice exists
...
&#x2022; `description` - Optional String<br>Description of the Srv6NetworkSlice
