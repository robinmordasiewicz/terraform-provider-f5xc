...
&#x2022; `name` - Required String<br>Name of the TicketTrackingSystem

&#x2022; `namespace` - Required String<br>Namespace where the TicketTrackingSystem exists
...
&#x2022; `description` - Optional String<br>Description of the TicketTrackingSystem
