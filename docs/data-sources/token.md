...
&#x2022; `name` - Required String<br>Name of the Token

&#x2022; `namespace` - Required String<br>Namespace where the Token exists
...
&#x2022; `description` - Optional String<br>Description of the Token
