...
&#x2022; `name` - Required String<br>Name of the TpmAPIKey

&#x2022; `namespace` - Required String<br>Namespace where the TpmAPIKey exists
...
&#x2022; `description` - Optional String<br>Description of the TpmAPIKey
