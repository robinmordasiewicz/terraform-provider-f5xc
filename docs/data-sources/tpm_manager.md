...
&#x2022; `name` - Required String<br>Name of the TpmManager

&#x2022; `namespace` - Required String<br>Namespace where the TpmManager exists
...
&#x2022; `description` - Optional String<br>Description of the TpmManager
