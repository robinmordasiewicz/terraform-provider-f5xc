...
&#x2022; `name` - Required String<br>Name of the TrustedCaList

&#x2022; `namespace` - Required String<br>Namespace where the TrustedCaList exists
...
&#x2022; `description` - Optional String<br>Description of the TrustedCaList
