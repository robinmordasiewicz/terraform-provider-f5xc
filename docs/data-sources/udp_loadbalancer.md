...
&#x2022; `name` - Required String<br>Name of the UDPLoadBalancer

&#x2022; `namespace` - Required String<br>Namespace where the UDPLoadBalancer exists
...
&#x2022; `description` - Optional String<br>Description of the UDPLoadBalancer
