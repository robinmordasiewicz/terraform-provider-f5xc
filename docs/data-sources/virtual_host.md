...
&#x2022; `name` - Required String<br>Name of the VirtualHost

&#x2022; `namespace` - Required String<br>Namespace where the VirtualHost exists
...
&#x2022; `description` - Optional String<br>Description of the VirtualHost
