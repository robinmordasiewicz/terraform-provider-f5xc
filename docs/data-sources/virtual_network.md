...
&#x2022; `name` - Required String<br>Name of the VirtualNetwork

&#x2022; `namespace` - Required String<br>Namespace where the VirtualNetwork exists
...
&#x2022; `description` - Optional String<br>Description of the VirtualNetwork
