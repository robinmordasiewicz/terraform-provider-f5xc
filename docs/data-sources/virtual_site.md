...
&#x2022; `name` - Required String<br>Name of the VirtualSite

&#x2022; `namespace` - Required String<br>Namespace where the VirtualSite exists
...
&#x2022; `description` - Optional String<br>Description of the VirtualSite
