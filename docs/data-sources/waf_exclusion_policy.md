...
&#x2022; `name` - Required String<br>Name of the WAFExclusionPolicy

&#x2022; `namespace` - Required String<br>Namespace where the WAFExclusionPolicy exists
...
&#x2022; `description` - Optional String<br>Description of the WAFExclusionPolicy
