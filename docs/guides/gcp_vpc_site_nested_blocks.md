---
page_title: "GCP Vpc Site Nested Blocks - f5xc Provider"
subcategory: "Sites"
description: |-
  Nested block reference for the GCP Vpc Site resource.
---

# GCP Vpc Site Nested Blocks

This page contains detailed documentation for nested blocks in the `f5xc_gcp_vpc_site` resource.

For the main resource documentation, see [f5xc_gcp_vpc_site](/docs/resources/gcp_vpc_site).
...
- [ingress-egress-gw-inside-network](#ingress-egress-gw-inside-network)
- [ingress-egress-gw-inside-network-existing-network](#ingress-egress-gw-inside-network-existing-network)
- [ingress-egress-gw-inside-network-new-network](#ingress-egress-gw-inside-network-new-network)
...
- [ingress-egress-gw-inside-subnet](#ingress-egress-gw-inside-subnet)
- [ingress-egress-gw-inside-subnet-existing-subnet](#ingress-egress-gw-inside-subnet-existing-subnet)
- [ingress-egress-gw-inside-subnet-new-subnet](#ingress-egress-gw-inside-subnet-new-subnet)
- [ingress-egress-gw-outside-network](#ingress-egress-gw-outside-network)
- [ingress-egress-gw-outside-network-existing-network](#ingress-egress-gw-outside-network-existing-network)
- [ingress-egress-gw-outside-network-new-network](#ingress-egress-gw-outside-network-new-network)
...
- [ingress-egress-gw-outside-subnet](#ingress-egress-gw-outside-subnet)
- [ingress-egress-gw-outside-subnet-existing-subnet](#ingress-egress-gw-outside-subnet-existing-subnet)
- [ingress-egress-gw-outside-subnet-new-subnet](#ingress-egress-gw-outside-subnet-new-subnet)
...
- [ingress-gw-local-network](#ingress-gw-local-network)
- [ingress-gw-local-network-existing-network](#ingress-gw-local-network-existing-network)
- [ingress-gw-local-network-new-network](#ingress-gw-local-network-new-network)
- [ingress-gw-local-subnet](#ingress-gw-local-subnet)
- [ingress-gw-local-subnet-existing-subnet](#ingress-gw-local-subnet-existing-subnet)
- [ingress-gw-local-subnet-new-subnet](#ingress-gw-local-subnet-new-subnet)
...
- [voltstack-cluster-site-local-network](#voltstack-cluster-site-local-network)
- [voltstack-cluster-site-local-network-existing-network](#voltstack-cluster-site-local-network-existing-network)
- [voltstack-cluster-site-local-network-new-network](#voltstack-cluster-site-local-network-new-network)
- [voltstack-cluster-site-local-subnet](#voltstack-cluster-site-local-subnet)
- [voltstack-cluster-site-local-subnet-existing-subnet](#voltstack-cluster-site-local-subnet-existing-subnet)
- [voltstack-cluster-site-local-subnet-new-subnet](#voltstack-cluster-site-local-subnet-new-subnet)
