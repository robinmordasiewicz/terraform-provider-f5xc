---
page_title: "Global Log Receiver Nested Blocks - f5xc Provider"
subcategory: "Monitoring"
description: |-
  Nested block reference for the Global Log Receiver resource.
---

# Global Log Receiver Nested Blocks

This page contains detailed documentation for nested blocks in the `f5xc_global_log_receiver` resource.

For the main resource documentation, see [f5xc_global_log_receiver](/docs/resources/global_log_receiver).

## Contents

- [aws-cloud-watch-receiver](#aws-cloud-watch-receiver)
- [aws-cloud-watch-receiver-aws-cred](#aws-cloud-watch-receiver-aws-cred)
- [aws-cloud-watch-receiver-batch](#aws-cloud-watch-receiver-batch)
- [aws-cloud-watch-receiver-compression](#aws-cloud-watch-receiver-compression)
- [azure-event-hubs-receiver](#azure-event-hubs-receiver)
- [azure-event-hubs-receiver-connection-string](#azure-event-hubs-receiver-connection-string)
- [azure-event-hubs-receiver-connection-string-blindfold-secret-info](#azure-event-hubs-receiver-connection-string-blindfold-secret-info)
- [azure-event-hubs-receiver-connection-string-clear-secret-info](#azure-event-hubs-receiver-connection-string-clear-secret-info)
- [azure-receiver](#azure-receiver)
- [azure-receiver-batch](#azure-receiver-batch)
- [azure-receiver-compression](#azure-receiver-compression)
- [azure-receiver-connection-string](#azure-receiver-connection-string)
- [azure-receiver-connection-string-blindfold-secret-info](#azure-receiver-connection-string-blindfold-secret-info)
- [azure-receiver-connection-string-clear-secret-info](#azure-receiver-connection-string-clear-secret-info)
- [azure-receiver-filename-options](#azure-receiver-filename-options)
- [datadog-receiver](#datadog-receiver)
- [datadog-receiver-batch](#datadog-receiver-batch)
- [datadog-receiver-compression](#datadog-receiver-compression)
- [datadog-receiver-datadog-api-key](#datadog-receiver-datadog-api-key)
- [datadog-receiver-datadog-api-key-blindfold-secret-info](#datadog-receiver-datadog-api-key-blindfold-secret-info)
- [datadog-receiver-datadog-api-key-clear-secret-info](#datadog-receiver-datadog-api-key-clear-secret-info)
- [datadog-receiver-use-tls](#datadog-receiver-use-tls)
- [datadog-receiver-use-tls-mtls-enable](#datadog-receiver-use-tls-mtls-enable)
- [gcp-bucket-receiver](#gcp-bucket-receiver)
- [gcp-bucket-receiver-batch](#gcp-bucket-receiver-batch)
- [gcp-bucket-receiver-compression](#gcp-bucket-receiver-compression)
- [gcp-bucket-receiver-filename-options](#gcp-bucket-receiver-filename-options)
- [gcp-bucket-receiver-gcp-cred](#gcp-bucket-receiver-gcp-cred)
- [http-receiver](#http-receiver)
- [http-receiver-auth-basic](#http-receiver-auth-basic)
- [http-receiver-auth-basic-password](#http-receiver-auth-basic-password)
- [http-receiver-auth-token](#http-receiver-auth-token)
- [http-receiver-auth-token-token](#http-receiver-auth-token-token)
- [http-receiver-batch](#http-receiver-batch)
- [http-receiver-compression](#http-receiver-compression)
- [http-receiver-use-tls](#http-receiver-use-tls)
- [http-receiver-use-tls-mtls-enable](#http-receiver-use-tls-mtls-enable)
- [kafka-receiver](#kafka-receiver)
- [kafka-receiver-batch](#kafka-receiver-batch)
- [kafka-receiver-compression](#kafka-receiver-compression)
- [kafka-receiver-use-tls](#kafka-receiver-use-tls)
- [kafka-receiver-use-tls-mtls-enable](#kafka-receiver-use-tls-mtls-enable)
- [new-relic-receiver](#new-relic-receiver)
- [new-relic-receiver-api-key](#new-relic-receiver-api-key)
- [new-relic-receiver-api-key-blindfold-secret-info](#new-relic-receiver-api-key-blindfold-secret-info)
- [new-relic-receiver-api-key-clear-secret-info](#new-relic-receiver-api-key-clear-secret-info)
- [ns-list](#ns-list)
- [qradar-receiver](#qradar-receiver)
- [qradar-receiver-batch](#qradar-receiver-batch)
- [qradar-receiver-compression](#qradar-receiver-compression)
- [qradar-receiver-use-tls](#qradar-receiver-use-tls)
- [qradar-receiver-use-tls-mtls-enable](#qradar-receiver-use-tls-mtls-enable)
- [s3-receiver](#s3-receiver)
- [s3-receiver-aws-cred](#s3-receiver-aws-cred)
- [s3-receiver-batch](#s3-receiver-batch)
- [s3-receiver-compression](#s3-receiver-compression)
- [s3-receiver-filename-options](#s3-receiver-filename-options)
- [splunk-receiver](#splunk-receiver)
- [splunk-receiver-batch](#splunk-receiver-batch)
- [splunk-receiver-compression](#splunk-receiver-compression)
- [splunk-receiver-splunk-hec-token](#splunk-receiver-splunk-hec-token)
- [splunk-receiver-splunk-hec-token-blindfold-secret-info](#splunk-receiver-splunk-hec-token-blindfold-secret-info)
- [splunk-receiver-splunk-hec-token-clear-secret-info](#splunk-receiver-splunk-hec-token-clear-secret-info)
- [splunk-receiver-use-tls](#splunk-receiver-use-tls)
- [splunk-receiver-use-tls-mtls-enable](#splunk-receiver-use-tls-mtls-enable)
- [sumo-logic-receiver](#sumo-logic-receiver)
- [sumo-logic-receiver-url](#sumo-logic-receiver-url)
- [sumo-logic-receiver-url-blindfold-secret-info](#sumo-logic-receiver-url-blindfold-secret-info)
- [sumo-logic-receiver-url-clear-secret-info](#sumo-logic-receiver-url-clear-secret-info)
- [timeouts](#timeouts)
