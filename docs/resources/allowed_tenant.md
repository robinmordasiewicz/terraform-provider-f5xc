...
`tenant_id` - (Optional) Allowed Tenant ID. Specify the Tenant ID of the Original Tenant which is allowed to manage. NOTE: this is the name of the tenant configuration obj. not UID. Required: YES ves.io.schema.rules.message (`String`).
