...
<br>&#x2022; `baremetal_site_type_choice` - (Optional) Virtual BIG-IP on App Stack Bare Metal Site. Virtual BIG-IP specification for App Stack Bare Metal Site. See [Baremetal Site Type Choice](#baremetal-site-type-choice) below for details.
