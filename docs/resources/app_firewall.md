...
`high_risk_action` - (Optional) Risk Based Blocking Action. Action to be performed on the request Log and block Log only (`String`).

`low_risk_action` - (Optional) Risk Based Blocking Action. Action to be performed on the request Log and block Log only (`String`).

`medium_risk_action` - (Optional) Risk Based Blocking Action. Action to be performed on the request Log and block Log only (`String`).
...
`good_bot_action` - (Optional) Bot Action. Action to be performed on the request Log and block Log only Disable detection (`String`).

`malicious_bot_action` - (Optional) Bot Action. Action to be performed on the request Log and block Log only Disable detection (`String`).

`suspicious_bot_action` - (Optional) Bot Action. Action to be performed on the request Log and block Log only Disable detection (`String`).
