...
<br><br>&#x2022; <a id="default-detection-settings"></a>[`default_detection_settings`](#default-detection-settings) - Optional Block  Defaults to `map[]`<br>Enable this option.  Server applies default when omitted

-> **One of the following:**
&#x2022; <a id="allow-all-response-codes"></a>[`allow_all_response_codes`](#allow-all-response-codes) - Optional Block  Defaults to `map[]`<br>Enable this option.  Server applies default when omitted
...
<br><br>&#x2022; <a id="default-anonymization"></a>[`default_anonymization`](#default-anonymization) - Optional Block  Defaults to `map[]`<br>Enable this option.  Server applies default when omitted

<a id="default-bot-setting"></a>&#x2022; [`default_bot_setting`](#default-bot-setting) - Optional Block  Defaults to `map[]`<br>Enable this option.  Server applies default when omitted
