...
-> **Note:** Only one of the following may be set: `custom_security_group`, `f5xc_security_group`
...
-> **Note:** Only one of the following may be set: `disable_internet_vip`, `enable_internet_vip`
...
-> **Note:** Only one of the following may be set: `egress_gateway_default`, `egress_nat_gw`, `egress_virtual_private_gateway`
...
-> **Note:** Only one of the following may be set: `f5_orchestrated_routing`, `manual_routing`
...
-> **Note:** Only one of the following may be set: `ingress_egress_gw`, `ingress_gw`, `voltstack_cluster`
