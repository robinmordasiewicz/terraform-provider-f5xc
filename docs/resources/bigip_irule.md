...
&#x2022; `name` - Required String<br>Name of the BigIPIrule. Must be unique within the namespace

&#x2022; `namespace` - Required String<br>Namespace where the BigIPIrule will be created
...
&#x2022; `code` - Optional String<br>iRule code. iRule code content, this content will be base64 encoded for preserving formating

&#x2022; `irule_name` - Optional String<br>iRule name. iRule name

&#x2022; `source` - Optional String<br>iRule source. iRule generation/updation source
