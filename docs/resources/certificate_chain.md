...
&#x2022; `name` - Required String<br>Name of the CertificateChain. Must be unique within the namespace

&#x2022; `namespace` - Required String<br>Namespace where the CertificateChain will be created
...
&#x2022; `certificate_url` - Optional String<br>Certificates. Certificate chain is the list of intermediate certificates in PEM format including the PEM headers
