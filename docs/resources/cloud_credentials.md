...
&#x2022; [`external_id_is_optional`](#external-id-is-optional) - Optional Block<br>Empty. This can be used for messages where no values are needed

&#x2022; [`external_id_is_tenant_id`](#external-id-is-tenant-id) - Optional Block<br>Empty. This can be used for messages where no values are needed

&#x2022; [`role_arn`](#role-arn) - Optional String<br>IAM Role ARN. IAM Role ARN to assume the role

&#x2022; [`session_name`](#session-name) - Optional String<br>Role Session Name. Use the role session name to uniquely identify a session, which will be used for deploy, monitor from F5XC console
...
&#x2022; [`client_secret`](#client-secret) - Optional Block<br>Secret. SecretType is used in an object to indicate a sensitive/confidential field<br>See [Client Secret](#azure-client-secret-client-secret) below.

&#x2022; [`subscription_id`](#subscription-id) - Optional String<br>Subscription ID. Subscription ID for your Azure service principal
...
&#x2022; [`password`](#password) - Optional Block<br>Secret. SecretType is used in an object to indicate a sensitive/confidential field<br>See [Password](#azure-pfx-certificate-password) below.
