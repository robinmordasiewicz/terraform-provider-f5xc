...
-> **Note:** Only one of the following may be set: `auto_http_config`, `http1_config`, `http2_options`
...
-> **Note:** Only one of the following may be set: `disable_proxy_protocol`, `proxy_protocol_v1`, `proxy_protocol_v2`
...
-> **Note:** Only one of the following may be set: `no_panic_threshold`, `panic_threshold`
