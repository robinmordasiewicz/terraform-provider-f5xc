...
&#x2022; `name` - Required String<br>Name of the ContainerRegistry. Must be unique within the namespace

&#x2022; `namespace` - Required String<br>Namespace where the ContainerRegistry will be created
...
&#x2022; `email` - Optional String<br>Email. Email used for the registry
...
&#x2022; `registry` - Optional String<br>Server FQDN. Fully qualified name of the registry login server

&#x2022; `timeouts` - Optional Block<br>See [Timeouts](#timeouts) below for details.

&#x2022; `user_name` - Optional String<br>User Name. Username used to access the registry
