...
<a id="name"></a>&#x2022; [`name`](#name) - Required String<br>Name of the DNS Compliance Checks. Must be unique within the namespace

<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the DNS Compliance Checks will be created
