...
resource "f5xc_endpoint" "example" {
  ...
  dns\_name\_advanced {
    # Configure dns\_name\_advanced settings
  }
...
<br><br>&#x2022; <a id="dns-name-advanced"></a>[`dns\_name\_advanced`](#dns-name-advanced) - Optional Block<br>DNS Name Advanced Type. Specifies name and TTL used for DNS resolution<br>See [DNS Name Advanced](#dns-name-advanced) below for details.
...
A [`dns\_name\_advanced`](#dns-name-advanced) block supports the following:
...
<a id="snat-pool-no-snat-pool"></a>&#x2022; [`no\_snat\_pool`](#snat-pool-no-snat-pool) - Optional Block<br>Empty. This can be used for messages where no values are needed

<a id="snat-pool-snat-pool"></a>&#x2022; [`snat_pool`](#snat-pool-snat-pool) - Optional Block<br>IPv4 Prefix List. x-example: '192.168.20.0/24' List of IPv4 prefixes that represent an endpoint<br>See [Snat Pool](#snat-pool-snat-pool) below.
