...
-> **Note:** Only one of the following may be set: `allow_all`, `allow_list`, `deny_list`, `rule_list`
...
-> **Note:** Only one of the following may be set: `any_proxy`, `drp_http_connect`, `network_connector`, `proxy_label_selector`
