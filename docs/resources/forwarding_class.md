...
-> **Note:** Only one of the following may be set: `dscp`, `no_marking`, `tos_value`
...
-> **Note:** Only one of the following may be set: `dscp_based_queue`, `queue_id_to_use`
...
-> **Note:** Only one of the following may be set: `no_policer`, `policer`
