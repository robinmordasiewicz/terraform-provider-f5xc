...
&#x2022; [`expressions`](#custom-geo-location-selector-expressions) - Optional List<br>Selector Expression. expressions contains the kubernetes style label expression for selections
