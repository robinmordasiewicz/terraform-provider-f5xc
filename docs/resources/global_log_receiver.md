...
-> **Note:** Only one of the following may be set: `audit_logs`, `dns_logs`, `request_logs`, `security_events`
...
-> **Note:** Only one of the following may be set: `aws_cloud_watch_receiver`, `azure_event_hubs_receiver`, `azure_receiver`, `datadog_receiver`, `gcp_bucket_receiver`, `http_receiver`, `kafka_receiver`, `new_relic_receiver`, `qradar_receiver`, `s3_receiver`, `splunk_receiver`, `sumo_logic_receiver`
...
-> **Note:** Only one of the following may be set: `ns_all`, `ns_current`, `ns_list`
