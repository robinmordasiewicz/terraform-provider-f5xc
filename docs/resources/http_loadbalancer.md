...
<br><br>&#x2022; <a id="disable-rate-limit"></a>[`disable_rate_limit`](#disable-rate-limit) - Optional Block<br>Can be used for messages where no values are needed
...
-> **One of the following:**
&#x2022; <a id="app-firewall"></a>[`app_firewall`](#app-firewall) - Optional Block<br>Type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name

<a id="blocked-clients"></a>&#x2022; [`blocked_clients`](#blocked-clients) - Optional Block<br>Define rules to block IP Prefixes or AS numbers
...
<br><br>&#x2022; <a id="no-challenge"></a>[`no_challenge`](#no-challenge) - Optional Block<br>Can be used for messages where no values are needed
...
<br><br>&#x2022; <a id="least-active"></a>[`least_active`](#least-active) - Optional Block<br>Can be used for messages where no values are needed
<br><br>&#x2022; <a id="random"></a>[`random`](#random) - Optional Block<br>Can be used for messages where no values are needed
<br><br>&#x2022; <a id="ring-hash"></a>[`ring_hash`](#ring-hash) - Optional Block<br>Hash Policy List. List of hash policy rules
<br><br>&#x2022; <a id="round-robin"></a>[`round_robin`](#round-robin) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="ddos-mitigation-rules"></a>&#x2022; [`ddos_mitigation_rules`](#ddos-mitigation-rules) - Optional Block<br>Define manual mitigation rules to block L7 DDOS attacks
...
-> **One of the following:**
&#x2022; <a id="default-sensitive-data-policy"></a>[`default_sensitive_data_policy`](#default-sensitive-data-policy) - Optional Block<br>Can be used for messages where no values are needed

<a id="disable-api-definition"></a>&#x2022; [`disable_api_definition`](#disable-api-definition) - Optional Block<br>Can be used for messages where no values are needed

-> **One of the following:**
&#x2022; <a id="disable-api-discovery"></a>[`disable_api_discovery`](#disable-api-discovery) - Optional Block<br>Can be used for messages where no values are needed

<a id="disable-api-testing"></a>&#x2022; [`disable_api_testing`](#disable-api-testing) - Optional Block<br>Can be used for messages where no values are needed

<a id="disable-bot-defense"></a>&#x2022; [`disable_bot_defense`](#disable-bot-defense) - Optional Block<br>Can be used for messages where no values are needed

<a id="disable-caching"></a>&#x2022; [`disable_caching`](#disable-caching) - Optional Block<br>Can be used for messages where no values are needed

<a id="disable-client-side-defense"></a>&#x2022; [`disable_client_side_defense`](#disable-client-side-defense) - Optional Block<br>Can be used for messages where no values are needed

-> **One of the following:**
&#x2022; <a id="disable-ip-reputation"></a>[`disable_ip_reputation`](#disable-ip-reputation) - Optional Block<br>Can be used for messages where no values are needed

-> **One of the following:**
&#x2022; <a id="disable-malicious-user-detection"></a>[`disable_malicious_user_detection`](#disable-malicious-user-detection) - Optional Block<br>Can be used for messages where no values are needed

-> **One of the following:**
&#x2022; <a id="disable-malware-protection"></a>[`disable_malware_protection`](#disable-malware-protection) - Optional Block<br>Can be used for messages where no values are needed

-> **One of the following:**
&#x2022; <a id="disable-threat-mesh"></a>[`disable_threat_mesh`](#disable-threat-mesh) - Optional Block<br>Can be used for messages where no values are needed

-> **One of the following:**
&#x2022; <a id="disable-trust-client-ip-headers"></a>[`disable_trust_client_ip_headers`](#disable-trust-client-ip-headers) - Optional Block<br>Can be used for messages where no values are needed

<a id="disable-waf"></a>&#x2022; [`disable_waf`](#disable-waf) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="enable-api-discovery"></a>&#x2022; [`enable_api_discovery`](#enable-api-discovery) - Optional Block<br>Specifies the settings used for API discovery
...
<a id="enable-malicious-user-detection"></a>&#x2022; [`enable_malicious_user_detection`](#enable-malicious-user-detection) - Optional Block<br>Can be used for messages where no values are needed

<a id="enable-threat-mesh"></a>&#x2022; [`enable_threat_mesh`](#enable-threat-mesh) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="graphql-rules"></a>&#x2022; [`graphql_rules`](#graphql-rules) - Optional Block<br>GraphQL is a query language and server-side runtime for APIs which provides a complete and understandable description of the data in API. GraphQL gives clients the power to ask for exactly what they need, makes it easier to evolve APIs over time, and enables powerful developer tools. Policy

-> **One of the following:**
&#x2022; <a id="http"></a>[`http`](#http) - Optional Block<br>HTTP Choice. Choice for selecting HTTP proxy
<br><br>&#x2022; <a id="https"></a>[`https`](#https) - Optional Block<br>Choice for selecting HTTP proxy with bring your own certificates

<a id="https-auto-cert"></a>&#x2022; [`https_auto_cert`](#https-auto-cert) - Optional Block<br>Choice for selecting HTTP proxy with bring your own certificates
...
-> **One of the following:**
&#x2022; <a id="l7-ddos-action-block"></a>[`l7_ddos_action_block`](#l7-ddos-action-block) - Optional Block<br>Can be used for messages where no values are needed
<br><br>&#x2022; <a id="l7-ddos-action-default"></a>[`l7_ddos_action_default`](#l7-ddos-action-default) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="l7-ddos-protection"></a>&#x2022; [`l7_ddos_protection`](#l7-ddos-protection) - Optional Block<br>L7 DDOS protection is critical for safeguarding web applications, APIs, and services that are exposed to the internet from sophisticated, volumetric, application-level threats. Configure actions, thresholds and policies to apply during L7 DDOS attack

<a id="malware-protection-settings"></a>&#x2022; [`malware_protection_settings`](#malware-protection-settings) - Optional Block<br>Malware Protection protects Web Apps and APIs, from malicious file uploads by scanning files in real-time

<a id="more-option"></a>&#x2022; [`more_option`](#more-option) - Optional Block<br>Defines various OPTIONS to define a route

-> **One of the following:**
&#x2022; <a id="multi-lb-app"></a>[`multi_lb_app`](#multi-lb-app) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="policy-based-challenge"></a>&#x2022; [`policy_based_challenge`](#policy-based-challenge) - Optional Block<br>Specifies the settings for policy rule based challenge
...
<a id="sensitive-data-disclosure-rules"></a>&#x2022; [`sensitive_data_disclosure_rules`](#sensitive-data-disclosure-rules) - Optional Block<br>Sensitive Data Exposure Rules allows specifying rules to mask sensitive data fields in API responses
...
<a id="source-ip-stickiness"></a>&#x2022; [`source_ip_stickiness`](#source-ip-stickiness) - Optional Block<br>Can be used for messages where no values are needed

<a id="system-default-timeouts"></a>&#x2022; [`system_default_timeouts`](#system-default-timeouts) - Optional Block<br>Can be used for messages where no values are needed
...
-> **One of the following:**
&#x2022; <a id="user-id-client-ip"></a>[`user_id_client_ip`](#user-id-client-ip) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="domain-c69c3a"></a>&#x2022; [`any_domain`](#domain-c69c3a) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="path-64d754"></a>&#x2022; [`api_endpoint_path`](#path-64d754) - Optional String<br>The endpoint (path) of the request
...
<a id="metadata-46451b"></a>&#x2022; [`metadata`](#metadata-46451b) - Optional Block<br>MessageMetaType is metadata (common attributes) of a message that only certain messages have. This information is propagated to the metadata of a child object that gets created from the containing message during view processing. The information in this type can be specified by user during create<br>See [Metadata](#metadata-46451b) below.
...
<a id="domain-745a34"></a>&#x2022; [`specific_domain`](#domain-745a34) - Optional String<br>The rule will apply for a specific domain. For
...
<a id="allow-9ca9d1"></a>&#x2022; [`allow`](#allow-9ca9d1) - Optional Block<br>Can be used for messages where no values are needed

<a id="deny-ec80de"></a>&#x2022; [`deny`](#deny-ec80de) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="name-af3d78"></a>&#x2022; [`name`](#name-af3d78) - Optional String<br>Name of the message. The value of name has to follow DNS-1035 format
...
<a id="domain-b1276e"></a>&#x2022; [`any_domain`](#domain-b1276e) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="metadata-b7fd60"></a>&#x2022; [`metadata`](#metadata-b7fd60) - Optional Block<br>MessageMetaType is metadata (common attributes) of a message that only certain messages have. This information is propagated to the metadata of a child object that gets created from the containing message during view processing. The information in this type can be specified by user during create<br>See [Metadata](#metadata-b7fd60) below.
...
<a id="domain-3d8e2d"></a>&#x2022; [`specific_domain`](#domain-3d8e2d) - Optional String<br>The rule will apply for a specific domain. For
...
<a id="allow-eba8d3"></a>&#x2022; [`allow`](#allow-eba8d3) - Optional Block<br>Can be used for messages where no values are needed

<a id="deny-99c219"></a>&#x2022; [`deny`](#deny-99c219) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="name-4148ef"></a>&#x2022; [`name`](#name-4148ef) - Optional String<br>Name of the message. The value of name has to follow DNS-1035 format
...
<a id="api-rate-limit-custom-ip-allowed-list"></a>&#x2022; [`custom_ip_allowed_list`](#api-rate-limit-custom-ip-allowed-list) - Optional Block<br>IP Allowed list using existing ip_prefix_set objects<br>See [Custom IP Allowed List](#api-rate-limit-custom-ip-allowed-list) below.
...
<a id="api-rate-limit-no-ip-allowed-list"></a>&#x2022; [`no_ip_allowed_list`](#api-rate-limit-no-ip-allowed-list) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="domain-cf087c"></a>&#x2022; [`any_domain`](#domain-cf087c) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="limiter-f23897"></a>&#x2022; [`ref_rate_limiter`](#limiter-f23897) - Optional Block<br>Type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [Ref Rate Limiter](#limiter-f23897) below.
...
<a id="rules-51aa34"></a>&#x2022; [`bypass_rate_limiting_rules`](#rules-51aa34) - Optional Block<br>Category defines rules per URL or API group. If request matches any of these rules, skip Rate Limiting<br>See [Bypass Rate Limiting Rules](#rules-51aa34) below.
...
<a id="prefixes-73df46"></a>&#x2022; [`rate_limiter_allowed_prefixes`](#prefixes-73df46) - Optional Block<br>References to ip_prefix_set objects. Requests from source IP addresses that are covered by one of the allowed IP Prefixes are not subjected to rate limiting<br>See [Rate Limiter Allowed Prefixes](#prefixes-73df46) below.
...
<a id="domain-0747c9"></a>&#x2022; [`any_domain`](#domain-0747c9) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="api-specification-api-definition"></a>&#x2022; [`api_definition`](#api-specification-api-definition) - Optional Block<br>Type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [API Definition](#api-specification-api-definition) below.
...
<a id="api-specification-validation-disabled"></a>&#x2022; [`validation_disabled`](#api-specification-validation-disabled) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="api-specification-api-definition-name"></a>&#x2022; [`name`](#api-specification-api-definition-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="namespace-c685bf"></a>&#x2022; [`namespace`](#namespace-c685bf) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="api-specification-api-definition-tenant"></a>&#x2022; [`tenant`](#api-specification-api-definition-tenant) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="mode-8425c5"></a>&#x2022; [`fall_through_mode`](#mode-8425c5) - Optional Block<br>Determine what to do with unprotected endpoints (not in the OpenAPI specification file (a.k.a. Swagger) or doesn't have a specific rule in custom rules)<br>See [Fall Through Mode](#mode-8425c5) below.

<a id="settings-a83a93"></a>&#x2022; [`settings`](#settings-a83a93) - Optional Block<br>OpenAPI specification validation settings relevant for 'API Inventory' enforcement and for 'Custom list' enforcement<br>See [Settings](#settings-a83a93) below.

<a id="mode-cd4a1c"></a>&#x2022; [`validation_mode`](#mode-cd4a1c) - Optional Block<br>Validation mode of OpenAPI specification. When a validation mismatch occurs on a request to one of the endpoints listed on the OpenAPI specification file (a.k.a. Swagger)<br>See [Validation Mode](#mode-cd4a1c) below.
...
<a id="validation-462f95"></a>&#x2022; [`oversized_body_fail_validation`](#validation-462f95) - Optional Block<br>Can be used for messages where no values are needed

<a id="validation-7ffaab"></a>&#x2022; [`oversized_body_skip_validation`](#validation-7ffaab) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="default-f746bd"></a>&#x2022; [`property_validation_settings_default`](#default-f746bd) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="validation-cfaf7f"></a>&#x2022; [`oversized_body_fail_validation`](#validation-cfaf7f) - Optional Block<br>Can be used for messages where no values are needed

<a id="validation-0639fa"></a>&#x2022; [`oversized_body_skip_validation`](#validation-0639fa) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="default-baec50"></a>&#x2022; [`property_validation_settings_default`](#default-baec50) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="api-testing-custom-header-value"></a>&#x2022; [`custom_header_value`](#api-testing-custom-header-value) - Optional String<br>Add x-F5-API-testing-identifier header value to prevent security flags on API testing traffic
...
<a id="api-testing-every-day"></a>&#x2022; [`every_day`](#api-testing-every-day) - Optional Block<br>Can be used for messages where no values are needed

<a id="api-testing-every-month"></a>&#x2022; [`every_month`](#api-testing-every-month) - Optional Block<br>Can be used for messages where no values are needed

<a id="api-testing-every-week"></a>&#x2022; [`every_week`](#api-testing-every-week) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="api-testing-domains-domain"></a>&#x2022; [`domain`](#api-testing-domains-domain) - Optional String<br>Add your testing environment domain. Be aware that running tests on a production domain can impact live applications, as API testing cannot distinguish between production and testing environments
...
<a id="api-testing-domains-credentials-admin"></a>&#x2022; [`admin`](#api-testing-domains-credentials-admin) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="name-8eb15c"></a>&#x2022; [`credential_name`](#name-8eb15c) - Optional String<br>Enter a unique name for the credentials used in API testing
...
<a id="standard-8b74a1"></a>&#x2022; [`standard`](#standard-8b74a1) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="value-f4a033"></a>&#x2022; [`value`](#value-f4a033) - Optional Block<br>SecretType is used in an object to indicate a sensitive/confidential field<br>See [Value](#value-f4a033) below.
...
<a id="password-e6a065"></a>&#x2022; [`password`](#password-e6a065) - Optional Block<br>SecretType is used in an object to indicate a sensitive/confidential field<br>See [Password](#password-e6a065) below.
...
<a id="token-7fcc22"></a>&#x2022; [`token`](#token-7fcc22) - Optional Block<br>SecretType is used in an object to indicate a sensitive/confidential field<br>See [Token](#token-7fcc22) below.
...
<a id="payload-cb9ddd"></a>&#x2022; [`json_payload`](#payload-cb9ddd) - Optional Block<br>SecretType is used in an object to indicate a sensitive/confidential field<br>See [JSON Payload](#payload-cb9ddd) below.

<a id="method-ccde95"></a>&#x2022; [`method`](#method-ccde95) - Optional String  Defaults to `ANY`<br>See [HTTP Methods](#common-http-methods)<br> Specifies the HTTP method used to access a resource. Any HTTP Method

<a id="path-fc4b22"></a>&#x2022; [`path`](#path-fc4b22) - Optional String<br>Path

<a id="key-04416f"></a>&#x2022; [`token_response_key`](#key-04416f) - Optional String<br>Specifies how to handle the API response, extracting authentication tokens
...
<a id="app-firewall-name"></a>&#x2022; [`name`](#app-firewall-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="app-firewall-namespace"></a>&#x2022; [`namespace`](#app-firewall-namespace) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="app-firewall-tenant"></a>&#x2022; [`tenant`](#app-firewall-tenant) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="blocked-clients-bot-skip-processing"></a>&#x2022; [`bot_skip_processing`](#blocked-clients-bot-skip-processing) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="blocked-clients-ip-prefix"></a>&#x2022; [`ip_prefix`](#blocked-clients-ip-prefix) - Optional String<br>IPv4 prefix string

<a id="blocked-clients-ipv6-prefix"></a>&#x2022; [`ipv6_prefix`](#blocked-clients-ipv6-prefix) - Optional String<br>IPv6 prefix string
...
<a id="blocked-clients-skip-processing"></a>&#x2022; [`skip_processing`](#blocked-clients-skip-processing) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="blocked-clients-waf-skip-processing"></a>&#x2022; [`waf_skip_processing`](#blocked-clients-waf-skip-processing) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="blocked-clients-http-header-headers"></a>&#x2022; [`headers`](#blocked-clients-http-header-headers) - Optional Block<br>List of HTTP header name and value pairs<br>See [Headers](#blocked-clients-http-header-headers) below.
...
<a id="exact-a1dbef"></a>&#x2022; [`exact`](#exact-a1dbef) - Optional String<br>Header value to match exactly

<a id="match-b2ef8e"></a>&#x2022; [`invert_match`](#match-b2ef8e) - Optional Bool<br>Invert the result of the match to detect missing header or non-matching value

<a id="name-dc6d90"></a>&#x2022; [`name`](#name-dc6d90) - Optional String<br>Name. Name of the header

<a id="presence-659464"></a>&#x2022; [`presence`](#presence-659464) - Optional Bool<br>If true, check for presence of header

<a id="regex-6757d0"></a>&#x2022; [`regex`](#regex-6757d0) - Optional String<br>Regex match of the header value in re2 format
...
<a id="bot-defense-disable-cors-support"></a>&#x2022; [`disable_cors_support`](#bot-defense-disable-cors-support) - Optional Block<br>Can be used for messages where no values are needed

<a id="bot-defense-enable-cors-support"></a>&#x2022; [`enable_cors_support`](#bot-defense-enable-cors-support) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="bot-defense-regional-endpoint"></a>&#x2022; [`regional_endpoint`](#bot-defense-regional-endpoint) - Optional String  Defaults to `AUTO`<br>Possible values are `AUTO`, `US`, `EU`, `ASIA`<br>[Enum: AUTO|US|EU|ASIA] Defines a selection for Bot Defense region - AUTO: AUTO Automatic selection based on client IP address - US: US US region - EU: EU European Union region - ASIA: ASIA Asia region
...
<a id="bot-defense-policy-disable-js-insert"></a>&#x2022; [`disable_js_insert`](#bot-defense-policy-disable-js-insert) - Optional Block<br>Can be used for messages where no values are needed

<a id="bot-defense-policy-disable-mobile-sdk"></a>&#x2022; [`disable_mobile_sdk`](#bot-defense-policy-disable-mobile-sdk) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="bot-defense-policy-js-insert-all-pages"></a>&#x2022; [`js_insert_all_pages`](#bot-defense-policy-js-insert-all-pages) - Optional Block<br>Insert Bot Defense JavaScript in all pages<br>See [Js Insert All Pages](#bot-defense-policy-js-insert-all-pages) below.

<a id="except-2f0f51"></a>&#x2022; [`js_insert_all_pages_except`](#except-2f0f51) - Optional Block<br>Insert Bot Defense JavaScript in all pages with the exceptions<br>See [Js Insert All Pages Except](#except-2f0f51) below.

<a id="bot-defense-policy-js-insertion-rules"></a>&#x2022; [`js_insertion_rules`](#bot-defense-policy-js-insertion-rules) - Optional Block<br>Defines custom JavaScript insertion rules for Bot Defense Policy<br>See [Js Insertion Rules](#bot-defense-policy-js-insertion-rules) below.
...
<a id="list-51668b"></a>&#x2022; [`exclude_list`](#list-51668b) - Optional Block<br>Optional JavaScript insertions exclude list of domain and path matchers<br>See [Exclude List](#list-51668b) below.

<a id="rules-15d983"></a>&#x2022; [`rules`](#rules-15d983) - Optional Block<br>Required list of pages to insert Bot Defense client JavaScript<br>See [Rules](#rules-15d983) below.
...
<a id="domain-f27f00"></a>&#x2022; [`any_domain`](#domain-f27f00) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="bots-cfdb6f"></a>&#x2022; [`allow_good_bots`](#bots-cfdb6f) - Optional Block<br>Can be used for messages where no values are needed

<a id="domain-f4f253"></a>&#x2022; [`any_domain`](#domain-f4f253) - Optional Block<br>Can be used for messages where no values are needed

<a id="domain-18bf1a"></a>&#x2022; [`domain`](#domain-18bf1a) - Optional Block<br>Domains. Domains names<br>See [Domain](#domain-18bf1a) below.

<a id="label-244fef"></a>&#x2022; [`flow_label`](#label-244fef) - Optional Block<br>Bot Defense Flow Label Category allows to associate traffic with selected category<br>See [Flow Label](#label-244fef) below.
...
<a id="bots-5c9c05"></a>&#x2022; [`mitigate_good_bots`](#bots-5c9c05) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="mobile-2839a0"></a>&#x2022; [`mobile`](#mobile-2839a0) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="protocol-21c1f1"></a>&#x2022; [`protocol`](#protocol-21c1f1) - Optional String  Defaults to `BOTH`<br>Possible values are `BOTH`, `HTTP`, `HTTPS`<br>[Enum: BOTH|HTTP|HTTPS] SchemeType is used to indicate URL scheme. - BOTH: BOTH URL scheme for HTTPS:// or HTTP://. - HTTP: HTTP URL scheme HTTP:// only. - HTTPS: HTTPS URL scheme HTTPS:// only
...
<a id="label-a84f6e"></a>&#x2022; [`undefined_flow_label`](#label-a84f6e) - Optional Block<br>Can be used for messages where no values are needed

<a id="web-a33d3d"></a>&#x2022; [`web`](#web-a33d3d) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="value-d5b836"></a>&#x2022; [`exact_value`](#value-d5b836) - Optional String<br>Exact domain name

<a id="value-4e4756"></a>&#x2022; [`regex_value`](#value-4e4756) - Optional String<br>Regular Expression value for the domain name

<a id="value-89654e"></a>&#x2022; [`suffix_value`](#value-89654e) - Optional String<br>Suffix of domain name e.g 'xyz.com' will match '*.xyz.com' and 'xyz.com'
...
<a id="present-2e9857"></a>&#x2022; [`check_not_present`](#present-2e9857) - Optional Block<br>Can be used for messages where no values are needed

<a id="present-3a1075"></a>&#x2022; [`check_present`](#present-3a1075) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="bot-defense-advanced-disable-js-insert"></a>&#x2022; [`disable_js_insert`](#bot-defense-advanced-disable-js-insert) - Optional Block<br>Can be used for messages where no values are needed

<a id="bot-defense-advanced-disable-mobile-sdk"></a>&#x2022; [`disable_mobile_sdk`](#bot-defense-advanced-disable-mobile-sdk) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="domain-bd13eb"></a>&#x2022; [`any_domain`](#domain-bd13eb) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="metadata-43c6ee"></a>&#x2022; [`metadata`](#metadata-43c6ee) - Optional Block<br>MessageMetaType is metadata (common attributes) of a message that only certain messages have. This information is propagated to the metadata of a child object that gets created from the containing message during view processing. The information in this type can be specified by user during create<br>See [Metadata](#metadata-43c6ee) below.
...
<a id="disabled-39759c"></a>&#x2022; [`cache_disabled`](#disabled-39759c) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="override-3c128f"></a>&#x2022; [`cache_ttl_override`](#override-3c128f) - Optional String<br>Always override the Cahce TTL provided by Origin
...
<a id="cookie-stickiness-add-httponly"></a>&#x2022; [`add_httponly`](#cookie-stickiness-add-httponly) - Optional Block<br>Can be used for messages where no values are needed

<a id="cookie-stickiness-add-secure"></a>&#x2022; [`add_secure`](#cookie-stickiness-add-secure) - Optional Block<br>Can be used for messages where no values are needed

<a id="cookie-stickiness-ignore-httponly"></a>&#x2022; [`ignore_httponly`](#cookie-stickiness-ignore-httponly) - Optional Block<br>Can be used for messages where no values are needed

<a id="cookie-stickiness-ignore-samesite"></a>&#x2022; [`ignore_samesite`](#cookie-stickiness-ignore-samesite) - Optional Block<br>Can be used for messages where no values are needed

<a id="cookie-stickiness-ignore-secure"></a>&#x2022; [`ignore_secure`](#cookie-stickiness-ignore-secure) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="cookie-stickiness-samesite-lax"></a>&#x2022; [`samesite_lax`](#cookie-stickiness-samesite-lax) - Optional Block<br>Can be used for messages where no values are needed

<a id="cookie-stickiness-samesite-none"></a>&#x2022; [`samesite_none`](#cookie-stickiness-samesite-none) - Optional Block<br>Can be used for messages where no values are needed

<a id="cookie-stickiness-samesite-strict"></a>&#x2022; [`samesite_strict`](#cookie-stickiness-samesite-strict) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="ddos-mitigation-rules-ip-prefix-list"></a>&#x2022; [`ip_prefix_list`](#ddos-mitigation-rules-ip-prefix-list) - Optional Block<br>List of IP Prefix strings to match against<br>See [IP Prefix List](#ddos-mitigation-rules-ip-prefix-list) below.

<a id="ddos-mitigation-rules-metadata"></a>&#x2022; [`metadata`](#ddos-mitigation-rules-metadata) - Optional Block<br>MessageMetaType is metadata (common attributes) of a message that only certain messages have. This information is propagated to the metadata of a child object that gets created from the containing message during view processing. The information in this type can be specified by user during create<br>See [Metadata](#ddos-mitigation-rules-metadata) below.
...
<a id="list-20cb78"></a>&#x2022; [`asn_list`](#list-20cb78) - Optional Block<br>Unordered set of RFC 6793 defined 4-byte AS numbers that can be used to create allow or deny lists for use in network policy or service policy. It can be used to create the allow list only for DNS Load Balancer<br>See [Asn List](#list-20cb78) below.
...
<a id="default-pool-automatic-port"></a>&#x2022; [`automatic_port`](#default-pool-automatic-port) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="default-pool-health-check-port"></a>&#x2022; [`health_check_port`](#default-pool-health-check-port) - Optional Number<br>Port used for performing health check
...
<a id="default-pool-lb-port"></a>&#x2022; [`lb_port`](#default-pool-lb-port) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="default-pool-no-tls"></a>&#x2022; [`no_tls`](#default-pool-no-tls) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="default-pool-same-as-endpoint-port"></a>&#x2022; [`same_as_endpoint_port`](#default-pool-same-as-endpoint-port) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="default-pool-view-internal"></a>&#x2022; [`view_internal`](#default-pool-view-internal) - Optional Block<br>Type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [View Internal](#default-pool-view-internal) below.
...
<a id="config-48f56b"></a>&#x2022; [`auto_http_config`](#config-48f56b) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="breaker-db5d25"></a>&#x2022; [`default_circuit_breaker`](#breaker-db5d25) - Optional Block<br>Can be used for messages where no values are needed

<a id="breaker-03c951"></a>&#x2022; [`disable_circuit_breaker`](#breaker-03c951) - Optional Block<br>Can be used for messages where no values are needed

<a id="persistance-83b4c4"></a>&#x2022; [`disable_lb_source_ip_persistance`](#persistance-83b4c4) - Optional Block<br>Can be used for messages where no values are needed

<a id="detection-46546c"></a>&#x2022; [`disable_outlier_detection`](#detection-46546c) - Optional Block<br>Can be used for messages where no values are needed

<a id="protocol-d614b9"></a>&#x2022; [`disable_proxy_protocol`](#protocol-d614b9) - Optional Block<br>Can be used for messages where no values are needed

<a id="subsets-b0bd38"></a>&#x2022; [`disable_subsets`](#subsets-b0bd38) - Optional Block<br>Can be used for messages where no values are needed

<a id="persistance-d799ee"></a>&#x2022; [`enable_lb_source_ip_persistance`](#persistance-d799ee) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="config-a0bc3c"></a>&#x2022; [`http1_config`](#config-a0bc3c) - Optional Block<br>HTTP/1.1 Protocol OPTIONS for upstream connections<br>See [Http1 Config](#config-a0bc3c) below.
...
<a id="threshold-4ef07a"></a>&#x2022; [`no_panic_threshold`](#threshold-4ef07a) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="protocol-v1-de8613"></a>&#x2022; [`proxy_protocol_v1`](#protocol-v1-de8613) - Optional Block<br>Can be used for messages where no values are needed

<a id="protocol-v2-5b9d69"></a>&#x2022; [`proxy_protocol_v2`](#protocol-v2-5b9d69) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="limit-866c11"></a>&#x2022; [`connection_limit`](#limit-866c11) - Optional Number<br>The maximum number of connections that loadbalancer will establish to all hosts in an upstream cluster. In practice this is only applicable to TCP and HTTP/1.1 clusters since HTTP/2 uses a single connection to each host. Remove endpoint out of load balancing decision, if number of connections

<a id="requests-ec6e61"></a>&#x2022; [`max_requests`](#requests-ec6e61) - Optional Number<br>The maximum number of requests that can be outstanding to all hosts in a cluster at any given time. In practice this is applicable to HTTP/2 clusters since HTTP/1.1 clusters are governed by the maximum connections (connection_limit). Remove endpoint out of load balancing decision, if requests

<a id="requests-d174a1"></a>&#x2022; [`pending_requests`](#requests-d174a1) - Optional Number<br>The maximum number of requests that will be queued while waiting for a ready connection pool connection. Since HTTP/2 requests are sent over a single connection, this circuit breaker only comes into play as the initial connection is created, as requests will be multiplexed immediately

<a id="priority-80164b"></a>&#x2022; [`priority`](#priority-80164b) - Optional String  Defaults to `DEFAULT`<br>Possible values are `DEFAULT`, `HIGH`<br>[Enum: DEFAULT|HIGH] Priority routing for each request. Different connection pools are used based on the priority selected for the request. Also, circuit-breaker configuration at destination cluster is chosen based on selected priority
...
<a id="endpoint-6dd4c1"></a>&#x2022; [`any_endpoint`](#endpoint-6dd4c1) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="request-26d37d"></a>&#x2022; [`fail_request`](#request-26d37d) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="transformation-cc4211"></a>&#x2022; [`header_transformation`](#transformation-cc4211) - Optional Block<br>Header Transformation OPTIONS for HTTP/1.1 request/response headers<br>See [Header Transformation](#transformation-cc4211) below.
...
<a id="time-fd8e40"></a>&#x2022; [`base_ejection_time`](#time-fd8e40) - Optional Number<br>The base time that a host is ejected for. The real time is equal to the base time multiplied by the number of times the host has been ejected. This causes hosts to GET ejected for longer periods if they continue to fail

<a id="5xx-1c4ec1"></a>&#x2022; [`consecutive_5xx`](#5xx-1c4ec1) - Optional Number<br>If an upstream endpoint returns some number of consecutive 5xx, it will be ejected. Note that in this case a 5xx means an actual 5xx respond code, or an event that would cause the HTTP router to return one on the upstream’s behalf(reset, connection failure, etc.) consecutive_5xx indicates the

<a id="failure-b19342"></a>&#x2022; [`consecutive_gateway_failure`](#failure-b19342) - Optional Number<br>If an upstream endpoint returns some number of consecutive “gateway errors” (502, 503 or 504 status code), it will be ejected. Note that this includes events that would cause the HTTP router to return one of these status codes on the upstream’s behalf (reset, connection failure, etc.)

<a id="interval-834cfc"></a>&#x2022; [`interval`](#interval-834cfc) - Optional Number  Defaults to `10000ms`<br>The time interval between ejection analysis sweeps. This can result in both new ejections as well as endpoints being returned to service
...
<a id="default-pool-healthcheck-name"></a>&#x2022; [`name`](#default-pool-healthcheck-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name
...
<a id="name-966ae3"></a>&#x2022; [`private_name`](#name-966ae3) - Optional Block<br>Specify origin server with private or public DNS name and site information<br>See [Private Name](#name-966ae3) below.

<a id="default-pool-origin-servers-public-ip"></a>&#x2022; [`public_ip`](#default-pool-origin-servers-public-ip) - Optional Block<br>Specify origin server with public IP address<br>See [Public IP](#default-pool-origin-servers-public-ip) below.

<a id="default-pool-origin-servers-public-name"></a>&#x2022; [`public_name`](#default-pool-origin-servers-public-name) - Optional Block<br>Specify origin server with public DNS name<br>See [Public Name](#default-pool-origin-servers-public-name) below.

<a id="private-ip-532445"></a>&#x2022; [`vn_private_ip`](#private-ip-532445) - Optional Block<br>Specify origin server with IP on Virtual Network<br>See [Vn Private IP](#private-ip-532445) below.

<a id="name-4a1747"></a>&#x2022; [`vn_private_name`](#name-4a1747) - Optional Block<br>Specify origin server with DNS name on Virtual Network<br>See [Vn Private Name](#name-4a1747) below.
...
<a id="name-231ea0"></a>&#x2022; [`service_name`](#name-231ea0) - Optional String<br>Name of the discovered Classic BIG-IP virtual server to be used as origin
...
<a id="network-654a28"></a>&#x2022; [`inside_network`](#network-654a28) - Optional Block<br>Can be used for messages where no values are needed

<a id="network-b1e5db"></a>&#x2022; [`outside_network`](#network-b1e5db) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="endpoint-952bdd"></a>&#x2022; [`endpoint`](#endpoint-952bdd) - Optional Block<br>Type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [Endpoint](#endpoint-952bdd) below.
...
<a id="network-dfbf17"></a>&#x2022; [`inside_network`](#network-dfbf17) - Optional Block<br>Can be used for messages where no values are needed

<a id="network-d1b956"></a>&#x2022; [`outside_network`](#network-d1b956) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="networks-03f764"></a>&#x2022; [`vk8s_networks`](#networks-03f764) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="network-704c7d"></a>&#x2022; [`inside_network`](#network-704c7d) - Optional Block<br>Can be used for messages where no values are needed

<a id="ip-ip-4a696b"></a>&#x2022; [`ip`](#ip-ip-4a696b) - Optional String<br>IP. Private IPv4 address

<a id="network-f44165"></a>&#x2022; [`outside_network`](#network-f44165) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="name-a7f063"></a>&#x2022; [`name`](#name-a7f063) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="namespace-4c09cc"></a>&#x2022; [`namespace`](#namespace-4c09cc) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="tenant-f972d4"></a>&#x2022; [`tenant`](#tenant-f972d4) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="network-e9e813"></a>&#x2022; [`inside_network`](#network-e9e813) - Optional Block<br>Can be used for messages where no values are needed

<a id="network-873dcb"></a>&#x2022; [`outside_network`](#network-873dcb) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="segment-8fe482"></a>&#x2022; [`segment`](#segment-8fe482) - Optional Block<br>Type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [Segment](#segment-8fe482) below.
...
<a id="name-88ec1c"></a>&#x2022; [`name`](#name-88ec1c) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="namespace-2f15e9"></a>&#x2022; [`namespace`](#namespace-2f15e9) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="tenant-1fee5d"></a>&#x2022; [`tenant`](#tenant-1fee5d) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="interval-ac5170"></a>&#x2022; [`refresh_interval`](#interval-ac5170) - Optional Number<br>Interval for DNS refresh in seconds. Max value is 7 days as per `HTTPS://datatracker.ietf.org/doc/HTML/rfc8767.`
...
<a id="network-56a203"></a>&#x2022; [`virtual_network`](#network-56a203) - Optional Block<br>Type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [Virtual Network](#network-56a203) below.
...
<a id="network-bbece7"></a>&#x2022; [`private_network`](#network-bbece7) - Optional Block<br>Type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [Private Network](#network-bbece7) below.
...
<a id="reuse-6660fb"></a>&#x2022; [`disable_conn_pool_reuse`](#reuse-6660fb) - Optional Block<br>Can be used for messages where no values are needed

<a id="reuse-52dccb"></a>&#x2022; [`enable_conn_pool_reuse`](#reuse-52dccb) - Optional Block<br>Can be used for messages where no values are needed

#### Default Pool Use TLS

An [`use_tls`](#default-pool-use-tls) block (within [`default_pool`](#default-pool)) supports the following:

<a id="caching-6d4585"></a>&#x2022; [`default_session_key_caching`](#caching-6d4585) - Optional Block<br>Can be used for messages where no values are needed

<a id="caching-e75c13"></a>&#x2022; [`disable_session_key_caching`](#caching-e75c13) - Optional Block<br>Can be used for messages where no values are needed

<a id="default-pool-use-tls-disable-sni"></a>&#x2022; [`disable_sni`](#default-pool-use-tls-disable-sni) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="default-pool-use-tls-no-mtls"></a>&#x2022; [`no_mtls`](#default-pool-use-tls-no-mtls) - Optional Block<br>Can be used for messages where no values are needed

<a id="verification-a40775"></a>&#x2022; [`skip_server_verification`](#verification-a40775) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="sni-a63eaf"></a>&#x2022; [`use_host_header_as_sni`](#sni-a63eaf) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="default-pool-use-tls-use-mtls-obj"></a>&#x2022; [`use_mtls_obj`](#default-pool-use-tls-use-mtls-obj) - Optional Block<br>Type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [Use mTLS Obj](#default-pool-use-tls-use-mtls-obj) below.
...
<a id="trusted-ca-e7a557"></a>&#x2022; [`volterra_trusted_ca`](#trusted-ca-e7a557) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="security-b532bd"></a>&#x2022; [`default_security`](#security-b532bd) - Optional Block<br>Can be used for messages where no values are needed

<a id="security-33124a"></a>&#x2022; [`low_security`](#security-33124a) - Optional Block<br>Can be used for messages where no values are needed

<a id="security-ea8e0f"></a>&#x2022; [`medium_security`](#security-ea8e0f) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="default-pool-use-tls-use-mtls-obj-name"></a>&#x2022; [`name`](#default-pool-use-tls-use-mtls-obj-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="namespace-5c1b91"></a>&#x2022; [`namespace`](#namespace-5c1b91) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="tenant-0b54b4"></a>&#x2022; [`tenant`](#tenant-0b54b4) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="trusted-ca-1da800"></a>&#x2022; [`trusted_ca`](#trusted-ca-1da800) - Optional Block<br>Type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [Trusted CA](#trusted-ca-1da800) below.

<a id="url-d5fda5"></a>&#x2022; [`trusted_ca_url`](#url-d5fda5) - Optional String<br>Upload a Root CA Certificate specifically for this Origin Pool for verification of server's certificate
...
<a id="default-pool-view-internal-name"></a>&#x2022; [`name`](#default-pool-view-internal-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="default-pool-view-internal-namespace"></a>&#x2022; [`namespace`](#default-pool-view-internal-namespace) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="default-pool-view-internal-tenant"></a>&#x2022; [`tenant`](#default-pool-view-internal-tenant) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="default-pool-list-pools-priority"></a>&#x2022; [`priority`](#default-pool-list-pools-priority) - Optional Number<br>Priority of this origin pool, valid only with multiple origin pools. Value of 0 will make the pool as lowest priority origin pool Priority of 1 means highest priority and is considered active. When active origin pool is not available, lower priority origin pools are made active as per the

<a id="default-pool-list-pools-weight"></a>&#x2022; [`weight`](#default-pool-list-pools-weight) - Optional Number<br>Weight of this origin pool, valid only with multiple origin pool. Value of 0 will disable the pool
...
<a id="default-pool-list-pools-cluster-name"></a>&#x2022; [`name`](#default-pool-list-pools-cluster-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="namespace-4d4aed"></a>&#x2022; [`namespace`](#namespace-4d4aed) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="default-pool-list-pools-cluster-tenant"></a>&#x2022; [`tenant`](#default-pool-list-pools-cluster-tenant) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="default-pool-list-pools-pool-name"></a>&#x2022; [`name`](#default-pool-list-pools-pool-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="default-pool-list-pools-pool-namespace"></a>&#x2022; [`namespace`](#default-pool-list-pools-pool-namespace) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="default-pool-list-pools-pool-tenant"></a>&#x2022; [`tenant`](#default-pool-list-pools-pool-tenant) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="default-route-pools-priority"></a>&#x2022; [`priority`](#default-route-pools-priority) - Optional Number<br>Priority of this origin pool, valid only with multiple origin pools. Value of 0 will make the pool as lowest priority origin pool Priority of 1 means highest priority and is considered active. When active origin pool is not available, lower priority origin pools are made active as per the

<a id="default-route-pools-weight"></a>&#x2022; [`weight`](#default-route-pools-weight) - Optional Number<br>Weight of this origin pool, valid only with multiple origin pool. Value of 0 will disable the pool
...
<a id="default-route-pools-cluster-name"></a>&#x2022; [`name`](#default-route-pools-cluster-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="default-route-pools-cluster-namespace"></a>&#x2022; [`namespace`](#default-route-pools-cluster-namespace) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="default-route-pools-cluster-tenant"></a>&#x2022; [`tenant`](#default-route-pools-cluster-tenant) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="default-route-pools-pool-name"></a>&#x2022; [`name`](#default-route-pools-pool-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="default-route-pools-pool-namespace"></a>&#x2022; [`namespace`](#default-route-pools-pool-namespace) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace
...
<a id="headers-cb3a8e"></a>&#x2022; [`client_ip_headers`](#headers-cb3a8e) - Optional List<br>Define the list of one or more Client IP Headers. Headers will be used in order from top to bottom, meaning if the first header is not present in the request, the system will proceed to check for the second header, and so on, until one of the listed headers is found. If none of the defined
...
<a id="https-append-server-name"></a>&#x2022; [`append_server_name`](#https-append-server-name) - Optional String<br>Define the header value for the header name “server”. If header value is already present, it is not overwritten and passed as-is

<a id="https-coalescing-options"></a>&#x2022; [`coalescing_options`](#https-coalescing-options) - Optional Block<br>TLS connection coalescing configuration (not compatible with mTLS)<br>See [Coalescing Options](#https-coalescing-options) below.
...
<a id="https-default-header"></a>&#x2022; [`default_header`](#https-default-header) - Optional Block<br>Can be used for messages where no values are needed

<a id="https-default-loadbalancer"></a>&#x2022; [`default_loadbalancer`](#https-default-loadbalancer) - Optional Block<br>Can be used for messages where no values are needed

<a id="https-disable-path-normalize"></a>&#x2022; [`disable_path_normalize`](#https-disable-path-normalize) - Optional Block<br>Can be used for messages where no values are needed

<a id="https-enable-path-normalize"></a>&#x2022; [`enable_path_normalize`](#https-enable-path-normalize) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="https-non-default-loadbalancer"></a>&#x2022; [`non_default_loadbalancer`](#https-non-default-loadbalancer) - Optional Block<br>Can be used for messages where no values are needed

<a id="https-pass-through"></a>&#x2022; [`pass_through`](#https-pass-through) - Optional Block<br>Can be used for messages where no values are needed

<a id="https-port"></a>&#x2022; [`port`](#https-port) - Optional Number<br>HTTPS port to Listen

<a id="https-port-ranges"></a>&#x2022; [`port_ranges`](#https-port-ranges) - Optional String<br>A string containing a comma separated list of port ranges. Each port range consists of a single port or two ports separated by '-'

<a id="https-server-name"></a>&#x2022; [`server_name`](#https-server-name) - Optional String<br>Define the header value for the header name “server”. This will overwrite existing values, if any, for the server header
...
<a id="coalescing-f90c69"></a>&#x2022; [`default_coalescing`](#coalescing-f90c69) - Optional Block<br>Can be used for messages where no values are needed

<a id="coalescing-c5278e"></a>&#x2022; [`strict_coalescing`](#coalescing-c5278e) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="v1-v2-6f8b9b"></a>&#x2022; [`http_protocol_enable_v1_v2`](#v1-v2-6f8b9b) - Optional Block<br>Can be used for messages where no values are needed

<a id="only-5cefb3"></a>&#x2022; [`http_protocol_enable_v2_only`](#only-5cefb3) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="https-tls-cert-params-no-mtls"></a>&#x2022; [`no_mtls`](#https-tls-cert-params-no-mtls) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="https-tls-cert-params-use-mtls"></a>&#x2022; [`use_mtls`](#https-tls-cert-params-use-mtls) - Optional Block<br>Validation context for downstream client TLS connections<br>See [Use mTLS](#https-tls-cert-params-use-mtls) below.
...
<a id="https-tls-cert-params-certificates-name"></a>&#x2022; [`name`](#https-tls-cert-params-certificates-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="namespace-74e8ce"></a>&#x2022; [`namespace`](#namespace-74e8ce) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace
...
<a id="security-b6db5a"></a>&#x2022; [`default_security`](#security-b6db5a) - Optional Block<br>Can be used for messages where no values are needed

<a id="security-cbe12e"></a>&#x2022; [`low_security`](#security-cbe12e) - Optional Block<br>Can be used for messages where no values are needed

<a id="security-e410e3"></a>&#x2022; [`medium_security`](#security-e410e3) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="optional-fd9757"></a>&#x2022; [`client_certificate_optional`](#optional-fd9757) - Optional Bool<br>Client certificate is optional. If the client has provided a certificate, the load balancer will verify it. If certification verification fails, the connection will be terminated
...
<a id="https-tls-cert-params-use-mtls-no-crl"></a>&#x2022; [`no_crl`](#https-tls-cert-params-use-mtls-no-crl) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="disabled-bc6638"></a>&#x2022; [`xfcc_disabled`](#disabled-bc6638) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="https-tls-cert-params-use-mtls-crl-name"></a>&#x2022; [`name`](#https-tls-cert-params-use-mtls-crl-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="namespace-4349dd"></a>&#x2022; [`namespace`](#namespace-4349dd) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace
...
<a id="https-tls-parameters-no-mtls"></a>&#x2022; [`no_mtls`](#https-tls-parameters-no-mtls) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="url-86f976"></a>&#x2022; [`certificate_url`](#url-86f976) - Optional String<br>TLS certificate. Certificate or certificate chain in PEM format including the PEM headers

<a id="algorithms-9ccf95"></a>&#x2022; [`custom_hash_algorithms`](#algorithms-9ccf95) - Optional Block<br>Specifies the hash algorithms to be used<br>See [Custom Hash Algorithms](#algorithms-9ccf95) below.

<a id="spec-77c99c"></a>&#x2022; [`description_spec`](#spec-77c99c) - Optional String<br>Description. Description for the certificate

<a id="stapling-fd931a"></a>&#x2022; [`disable_ocsp_stapling`](#stapling-fd931a) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="defaults-2777d9"></a>&#x2022; [`use_system_defaults`](#defaults-2777d9) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="security-fd7aef"></a>&#x2022; [`default_security`](#security-fd7aef) - Optional Block<br>Can be used for messages where no values are needed

<a id="security-c7d5df"></a>&#x2022; [`low_security`](#security-c7d5df) - Optional Block<br>Can be used for messages where no values are needed

<a id="security-3f26ed"></a>&#x2022; [`medium_security`](#security-3f26ed) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="suites-4e37c7"></a>&#x2022; [`cipher_suites`](#suites-4e37c7) - Optional List<br>The TLS listener will only support the specified cipher list
...
<a id="optional-9a0326"></a>&#x2022; [`client_certificate_optional`](#optional-9a0326) - Optional Bool<br>Client certificate is optional. If the client has provided a certificate, the load balancer will verify it. If certification verification fails, the connection will be terminated
...
<a id="https-tls-parameters-use-mtls-no-crl"></a>&#x2022; [`no_crl`](#https-tls-parameters-use-mtls-no-crl) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="disabled-5c360d"></a>&#x2022; [`xfcc_disabled`](#disabled-5c360d) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="https-tls-parameters-use-mtls-crl-name"></a>&#x2022; [`name`](#https-tls-parameters-use-mtls-crl-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="namespace-ae83ff"></a>&#x2022; [`namespace`](#namespace-ae83ff) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace
...
<a id="name-7721af"></a>&#x2022; [`name`](#name-7721af) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name
...
<a id="elements-52ccb1"></a>&#x2022; [`xfcc_header_elements`](#elements-52ccb1) - Optional List  Defaults to `XFCC_NONE`<br>Possible values are `XFCC_NONE`, `XFCC_CERT`, `XFCC_CHAIN`, `XFCC_SUBJECT`, `XFCC_URI`, `XFCC_DNS`<br>[Enum: XFCC_NONE|XFCC_CERT|XFCC_CHAIN|XFCC_SUBJECT|XFCC_URI|XFCC_DNS] X-Forwarded-Client-Cert header elements to be added to requests
...
<a id="https-auto-cert-default-header"></a>&#x2022; [`default_header`](#https-auto-cert-default-header) - Optional Block<br>Can be used for messages where no values are needed

<a id="https-auto-cert-default-loadbalancer"></a>&#x2022; [`default_loadbalancer`](#https-auto-cert-default-loadbalancer) - Optional Block<br>Can be used for messages where no values are needed

<a id="https-auto-cert-disable-path-normalize"></a>&#x2022; [`disable_path_normalize`](#https-auto-cert-disable-path-normalize) - Optional Block<br>Can be used for messages where no values are needed

<a id="https-auto-cert-enable-path-normalize"></a>&#x2022; [`enable_path_normalize`](#https-auto-cert-enable-path-normalize) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="https-auto-cert-no-mtls"></a>&#x2022; [`no_mtls`](#https-auto-cert-no-mtls) - Optional Block<br>Can be used for messages where no values are needed

<a id="loadbalancer-eb605c"></a>&#x2022; [`non_default_loadbalancer`](#loadbalancer-eb605c) - Optional Block<br>Can be used for messages where no values are needed

<a id="https-auto-cert-pass-through"></a>&#x2022; [`pass_through`](#https-auto-cert-pass-through) - Optional Block<br>Can be used for messages where no values are needed

<a id="https-auto-cert-port"></a>&#x2022; [`port`](#https-auto-cert-port) - Optional Number<br>HTTPS port to Listen

<a id="https-auto-cert-port-ranges"></a>&#x2022; [`port_ranges`](#https-auto-cert-port-ranges) - Optional String<br>A string containing a comma separated list of port ranges. Each port range consists of a single port or two ports separated by '-'

<a id="https-auto-cert-server-name"></a>&#x2022; [`server_name`](#https-auto-cert-server-name) - Optional String<br>Define the header value for the header name “server”. This will overwrite existing values, if any, for the server header
...
<a id="https-auto-cert-use-mtls"></a>&#x2022; [`use_mtls`](#https-auto-cert-use-mtls) - Optional Block<br>Validation context for downstream client TLS connections<br>See [Use mTLS](#https-auto-cert-use-mtls) below.
...
<a id="coalescing-3c2270"></a>&#x2022; [`default_coalescing`](#coalescing-3c2270) - Optional Block<br>Can be used for messages where no values are needed

<a id="coalescing-010f02"></a>&#x2022; [`strict_coalescing`](#coalescing-010f02) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="v1-v2-9e0811"></a>&#x2022; [`http_protocol_enable_v1_v2`](#v1-v2-9e0811) - Optional Block<br>Can be used for messages where no values are needed

<a id="only-65e5e2"></a>&#x2022; [`http_protocol_enable_v2_only`](#only-65e5e2) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="security-121c52"></a>&#x2022; [`default_security`](#security-121c52) - Optional Block<br>Can be used for messages where no values are needed

<a id="https-auto-cert-tls-config-low-security"></a>&#x2022; [`low_security`](#https-auto-cert-tls-config-low-security) - Optional Block<br>Can be used for messages where no values are needed

<a id="security-5e1ea1"></a>&#x2022; [`medium_security`](#security-5e1ea1) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="suites-c101c3"></a>&#x2022; [`cipher_suites`](#suites-c101c3) - Optional List<br>The TLS listener will only support the specified cipher list
...
<a id="optional-4b03b7"></a>&#x2022; [`client_certificate_optional`](#optional-4b03b7) - Optional Bool<br>Client certificate is optional. If the client has provided a certificate, the load balancer will verify it. If certification verification fails, the connection will be terminated
...
<a id="https-auto-cert-use-mtls-no-crl"></a>&#x2022; [`no_crl`](#https-auto-cert-use-mtls-no-crl) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="https-auto-cert-use-mtls-xfcc-disabled"></a>&#x2022; [`xfcc_disabled`](#https-auto-cert-use-mtls-xfcc-disabled) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="https-auto-cert-use-mtls-crl-name"></a>&#x2022; [`name`](#https-auto-cert-use-mtls-crl-name) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="https-auto-cert-use-mtls-crl-namespace"></a>&#x2022; [`namespace`](#https-auto-cert-use-mtls-crl-namespace) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace
...
<a id="name-36a848"></a>&#x2022; [`name`](#name-36a848) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name
...
<a id="elements-3cb07c"></a>&#x2022; [`xfcc_header_elements`](#elements-3cb07c) - Optional List  Defaults to `XFCC_NONE`<br>Possible values are `XFCC_NONE`, `XFCC_CERT`, `XFCC_CHAIN`, `XFCC_SUBJECT`, `XFCC_URI`, `XFCC_DNS`<br>[Enum: XFCC_NONE|XFCC_CERT|XFCC_CHAIN|XFCC_SUBJECT|XFCC_URI|XFCC_DNS] X-Forwarded-Client-Cert header elements to be added to requests
...
<a id="challenge-84ab9e"></a>&#x2022; [`clientside_action_captcha_challenge`](#challenge-84ab9e) - Optional Block<br>Enables loadbalancer to perform captcha challenge Captcha challenge will be based on Google Recaptcha. With this feature enabled, only clients that pass the captcha challenge will be allowed to complete the HTTP request. When loadbalancer is configured to do Captcha Challenge, it will redirect<br>See [Clientside Action Captcha Challenge](#challenge-84ab9e) below.
...
<a id="none-88961b"></a>&#x2022; [`clientside_action_none`](#none-88961b) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="l7-ddos-protection-ddos-policy-none"></a>&#x2022; [`ddos_policy_none`](#l7-ddos-protection-ddos-policy-none) - Optional Block<br>Can be used for messages where no values are needed

<a id="threshold-332758"></a>&#x2022; [`default_rps_threshold`](#threshold-332758) - Optional Block<br>Can be used for messages where no values are needed

<a id="l7-ddos-protection-mitigation-block"></a>&#x2022; [`mitigation_block`](#l7-ddos-protection-mitigation-block) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="challenge-2a2755"></a>&#x2022; [`mitigation_js_challenge`](#challenge-2a2755) - Optional Block<br>Enables loadbalancer to perform client browser compatibility test by redirecting to a page with Javascript. With this feature enabled, only clients that are capable of executing Javascript(mostly browsers) will be allowed to complete the HTTP request. When loadbalancer is configured to do<br>See [Mitigation Js Challenge](#challenge-2a2755) below.

<a id="l7-ddos-protection-rps-threshold"></a>&#x2022; [`rps_threshold`](#l7-ddos-protection-rps-threshold) - Optional Number<br>Configure custom RPS threshold
...
<a id="name-21c5e6"></a>&#x2022; [`name`](#name-21c5e6) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name
...
<a id="rules-b2bf3e"></a>&#x2022; [`malware_protection_rules`](#rules-b2bf3e) - Optional Block<br>Configure the match criteria to trigger Malware Protection Scan<br>See [Malware Protection Rules](#rules-b2bf3e) below.
...
<a id="metadata-20b73a"></a>&#x2022; [`metadata`](#metadata-20b73a) - Optional Block<br>MessageMetaType is metadata (common attributes) of a message that only certain messages have. This information is propagated to the metadata of a child object that gets created from the containing message during view processing. The information in this type can be specified by user during create<br>See [Metadata](#metadata-20b73a) below.

<a id="path-ce187c"></a>&#x2022; [`path`](#path-ce187c) - Optional Block<br>Path match of the URI can be either be, Prefix match or exact match or regular expression match<br>See [Path](#path-ce187c) below.
...
<a id="block-97253f"></a>&#x2022; [`block`](#block-97253f) - Optional Block<br>Can be used for messages where no values are needed

<a id="report-055d2b"></a>&#x2022; [`report`](#report-055d2b) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="domain-5794b8"></a>&#x2022; [`any_domain`](#domain-5794b8) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="name-34fca6"></a>&#x2022; [`name`](#name-34fca6) - Optional String<br>Name of the message. The value of name has to follow DNS-1035 format
...
<a id="path-2aac29"></a>&#x2022; [`path`](#path-2aac29) - Optional String<br>Exact path value to match

<a id="prefix-4ddbaa"></a>&#x2022; [`prefix`](#prefix-4ddbaa) - Optional String<br>Path prefix to match (e.g. The value / will match on all paths)

<a id="regex-56e93f"></a>&#x2022; [`regex`](#regex-56e93f) - Optional String<br>Regular expression of path match (e.g. The value .* will match on all paths)

#### More Option

A [`more_option`](#more-option) block supports the following:

<a id="more-option-buffer-policy"></a>&#x2022; [`buffer_policy`](#more-option-buffer-policy) - Optional Block<br>Some upstream applications are not capable of handling streamed data. This config enables buffering the entire request before sending to upstream application. We can specify the maximum buffer size and buffer interval with this config<br>See [Buffer Policy](#more-option-buffer-policy) below.

<a id="more-option-compression-params"></a>&#x2022; [`compression_params`](#more-option-compression-params) - Optional Block<br>Enables loadbalancer to compress dispatched data from an upstream service upon client request. The content is compressed and then sent to the client with the appropriate headers if either response and request allow. Only GZIP compression is supported<br>See [Compression Params](#more-option-compression-params) below.
...
<a id="more-option-disable-path-normalize"></a>&#x2022; [`disable_path_normalize`](#more-option-disable-path-normalize) - Optional Block<br>Can be used for messages where no values are needed

<a id="more-option-enable-path-normalize"></a>&#x2022; [`enable_path_normalize`](#more-option-enable-path-normalize) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="more-option-max-request-header-size"></a>&#x2022; [`max_request_header_size`](#more-option-max-request-header-size) - Optional Number<br>The maximum request header size for downstream connections, in KiB. A HTTP 431 (Request Header Fields Too Large) error code is sent for requests that exceed this size. If multiple load balancers share the same advertise_policy, the highest value configured across all such load balancers is used
...
<a id="more-option-request-cookies-to-remove"></a>&#x2022; [`request_cookies_to_remove`](#more-option-request-cookies-to-remove) - Optional List<br>List of keys of Cookies to be removed from the HTTP request being sent towards upstream

<a id="more-option-request-headers-to-add"></a>&#x2022; [`request_headers_to_add`](#more-option-request-headers-to-add) - Optional Block<br>Headers are key-value pairs to be added to HTTP request being routed towards upstream. Headers specified at this level are applied after headers from matched Route are applied<br>See [Request Headers To Add](#more-option-request-headers-to-add) below.

<a id="more-option-request-headers-to-remove"></a>&#x2022; [`request_headers_to_remove`](#more-option-request-headers-to-remove) - Optional List<br>List of keys of Headers to be removed from the HTTP request being sent towards upstream

<a id="more-option-response-cookies-to-add"></a>&#x2022; [`response_cookies_to_add`](#more-option-response-cookies-to-add) - Optional Block<br>Cookies are name-value pairs along with optional attribute parameters to be added to HTTP response being sent towards downstream. Cookies specified at this level are applied after cookies from matched Route are applied<br>See [Response Cookies To Add](#more-option-response-cookies-to-add) below.

<a id="more-option-response-cookies-to-remove"></a>&#x2022; [`response_cookies_to_remove`](#more-option-response-cookies-to-remove) - Optional List<br>List of name of Cookies to be removed from the HTTP response being sent towards downstream. Entire set-cookie header will be removed

<a id="more-option-response-headers-to-add"></a>&#x2022; [`response_headers_to_add`](#more-option-response-headers-to-add) - Optional Block<br>Headers are key-value pairs to be added to HTTP response being sent towards downstream. Headers specified at this level are applied after headers from matched Route are applied<br>See [Response Headers To Add](#more-option-response-headers-to-add) below.

<a id="more-option-response-headers-to-remove"></a>&#x2022; [`response_headers_to_remove`](#more-option-response-headers-to-remove) - Optional List<br>List of keys of Headers to be removed from the HTTP response being sent towards downstream
...
<a id="more-option-buffer-policy-disabled"></a>&#x2022; [`disabled`](#more-option-buffer-policy-disabled) - Optional Bool<br>Disable buffering for a particular route. This is useful when virtual-host has buffering, but we need to disable it on a specific route. The value of this field is ignored for virtual-host

<a id="bytes-49c09c"></a>&#x2022; [`max_request_bytes`](#bytes-49c09c) - Optional Number<br>The maximum request size that the filter will buffer before the connection manager will stop buffering and return a RequestEntityTooLarge (413) response
...
<a id="length-5f90b4"></a>&#x2022; [`content_length`](#length-5f90b4) - Optional Number  Defaults to `30`<br>Minimum response length, in bytes, which will trigger compression. The

<a id="type-163d4d"></a>&#x2022; [`content_type`](#type-163d4d) - Optional List<br>Set of strings that allows specifying which mime-types yield compression When this field is not defined, compression will be applied to the following mime-types: 'application/javascript' 'application/JSON', 'application/xhtml+XML' 'image/svg+XML' 'text/CSS' 'text/HTML' 'text/plain' 'text/XML'
...
<a id="more-option-request-cookies-to-add-name"></a>&#x2022; [`name`](#more-option-request-cookies-to-add-name) - Optional String<br>Name of the cookie in Cookie header

<a id="overwrite-6d9c60"></a>&#x2022; [`overwrite`](#overwrite-6d9c60) - Optional Bool  Defaults to `do`<br>Should the value be overwritten? If true, the value is overwritten to existing values. not overwrite

<a id="value-2d505e"></a>&#x2022; [`secret_value`](#value-2d505e) - Optional Block<br>SecretType is used in an object to indicate a sensitive/confidential field<br>See [Secret Value](#value-2d505e) below.

<a id="value-9c117c"></a>&#x2022; [`value`](#value-9c117c) - Optional String<br>Value of the Cookie header
...
<a id="append-2047af"></a>&#x2022; [`append`](#append-2047af) - Optional Bool  Defaults to `do`<br>Should the value be appended? If true, the value is appended to existing values. not append
...
<a id="value-d68008"></a>&#x2022; [`secret_value`](#value-d68008) - Optional Block<br>SecretType is used in an object to indicate a sensitive/confidential field<br>See [Secret Value](#value-d68008) below.

<a id="value-7dbd74"></a>&#x2022; [`value`](#value-7dbd74) - Optional String<br>Value of the HTTP header
...
<a id="domain-90efef"></a>&#x2022; [`add_domain`](#domain-90efef) - Optional String<br>Add domain attribute

<a id="expiry-5d54ee"></a>&#x2022; [`add_expiry`](#expiry-5d54ee) - Optional String<br>Add expiry attribute

<a id="httponly-8439bf"></a>&#x2022; [`add_httponly`](#httponly-8439bf) - Optional Block<br>Can be used for messages where no values are needed

<a id="partitioned-781e49"></a>&#x2022; [`add_partitioned`](#partitioned-781e49) - Optional Block<br>Can be used for messages where no values are needed

<a id="path-e18695"></a>&#x2022; [`add_path`](#path-e18695) - Optional String<br>Add path attribute

<a id="secure-e3baa0"></a>&#x2022; [`add_secure`](#secure-e3baa0) - Optional Block<br>Can be used for messages where no values are needed

<a id="domain-6328c3"></a>&#x2022; [`ignore_domain`](#domain-6328c3) - Optional Block<br>Can be used for messages where no values are needed

<a id="expiry-49396f"></a>&#x2022; [`ignore_expiry`](#expiry-49396f) - Optional Block<br>Can be used for messages where no values are needed

<a id="httponly-6fac42"></a>&#x2022; [`ignore_httponly`](#httponly-6fac42) - Optional Block<br>Can be used for messages where no values are needed

<a id="age-d6a859"></a>&#x2022; [`ignore_max_age`](#age-d6a859) - Optional Block<br>Can be used for messages where no values are needed

<a id="partitioned-f4bce0"></a>&#x2022; [`ignore_partitioned`](#partitioned-f4bce0) - Optional Block<br>Can be used for messages where no values are needed

<a id="path-f6b7e0"></a>&#x2022; [`ignore_path`](#path-f6b7e0) - Optional Block<br>Can be used for messages where no values are needed

<a id="samesite-aceec3"></a>&#x2022; [`ignore_samesite`](#samesite-aceec3) - Optional Block<br>Can be used for messages where no values are needed

<a id="secure-fe1099"></a>&#x2022; [`ignore_secure`](#secure-fe1099) - Optional Block<br>Can be used for messages where no values are needed

<a id="value-bbe342"></a>&#x2022; [`ignore_value`](#value-bbe342) - Optional Block<br>Can be used for messages where no values are needed

<a id="value-cb17ee"></a>&#x2022; [`max_age_value`](#value-cb17ee) - Optional Number<br>Add max age attribute

<a id="name-9a2258"></a>&#x2022; [`name`](#name-9a2258) - Optional String<br>Name of the cookie in Cookie header
...
<a id="lax-9d99f8"></a>&#x2022; [`samesite_lax`](#lax-9d99f8) - Optional Block<br>Can be used for messages where no values are needed

<a id="none-4de9cb"></a>&#x2022; [`samesite_none`](#none-4de9cb) - Optional Block<br>Can be used for messages where no values are needed

<a id="strict-d87273"></a>&#x2022; [`samesite_strict`](#strict-d87273) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="append-f099c0"></a>&#x2022; [`append`](#append-f099c0) - Optional Bool  Defaults to `do`<br>Should the value be appended? If true, the value is appended to existing values. not append

<a id="name-9f1ebf"></a>&#x2022; [`name`](#name-9f1ebf) - Optional String<br>Name. Name of the HTTP header

<a id="value-76f49e"></a>&#x2022; [`secret_value`](#value-76f49e) - Optional Block<br>SecretType is used in an object to indicate a sensitive/confidential field<br>See [Secret Value](#value-76f49e) below.

<a id="value-06dc79"></a>&#x2022; [`value`](#value-06dc79) - Optional String<br>Value of the HTTP header
...
<a id="rules-7a881b"></a>&#x2022; [`origin_server_subset_rules`](#rules-7a881b) - Optional Block<br>Origin Server Subset Rules allow users to define match condition on Client (IP address, ASN, Country), IP Reputation, Regional Edge names, Request for subset selection of origin servers. Origin Server Subset is a sequential engine where rules are evaluated one after the other. It's important to<br>See [Origin Server Subset Rules](#rules-7a881b) below.
...
<a id="policy-based-challenge-no-challenge"></a>&#x2022; [`no_challenge`](#policy-based-challenge-no-challenge) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="name-44607a"></a>&#x2022; [`name`](#name-44607a) - Optional String<br>Name of the message. The value of name has to follow DNS-1035 format
...
<a id="asn-cae05d"></a>&#x2022; [`any_asn`](#asn-cae05d) - Optional Block<br>Can be used for messages where no values are needed

<a id="client-df7cdb"></a>&#x2022; [`any_client`](#client-df7cdb) - Optional Block<br>Can be used for messages where no values are needed

<a id="any-ip-6a2554"></a>&#x2022; [`any_ip`](#any-ip-6a2554) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="selector-ca44f5"></a>&#x2022; [`client_selector`](#selector-ca44f5) - Optional Block<br>Type can be used to establish a 'selector reference' from one object(called selector) to a set of other objects(called selectees) based on the value of expresssions. A label selector is a label query over a set of resources. An empty label selector matches all objects<br>See [Client Selector](#selector-ca44f5) below.
...
<a id="challenge-fbd9a1"></a>&#x2022; [`disable_challenge`](#challenge-fbd9a1) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="challenge-e0353b"></a>&#x2022; [`enable_captcha_challenge`](#challenge-e0353b) - Optional Block<br>Can be used for messages where no values are needed

<a id="challenge-3644c3"></a>&#x2022; [`enable_javascript_challenge`](#challenge-3644c3) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="method-9ab722"></a>&#x2022; [`http_method`](#method-9ab722) - Optional Block<br>HTTP method matcher specifies a list of methods to match an input HTTP method. The match is considered successful if the input method is a member of the list. The result of the match based on the method list is inverted if invert_matcher is true<br>See [HTTP Method](#method-9ab722) below.

<a id="matcher-82616b"></a>&#x2022; [`ip_matcher`](#matcher-82616b) - Optional Block<br>Match any IP prefix contained in the list of ip_prefix_sets. The result of the match is inverted if invert_matcher is true<br>See [IP Matcher](#matcher-82616b) below.

<a id="list-537143"></a>&#x2022; [`ip_prefix_list`](#list-537143) - Optional Block<br>List of IP Prefix strings to match against<br>See [IP Prefix List](#list-537143) below.
...
<a id="params-04b1ad"></a>&#x2022; [`query_params`](#params-04b1ad) - Optional Block<br>List of predicates for all query parameters that need to be matched. The criteria for matching each query parameter are described in individual instances of QueryParameterMatcherType. The actual query parameter values are extracted from the request API as a list of strings for each query<br>See [Query Params](#params-04b1ad) below.
...
<a id="ring-hash-hash-policy"></a>&#x2022; [`hash_policy`](#ring-hash-hash-policy) - Optional Block<br>Specifies a list of hash policies to use for ring hash load balancing. Each hash policy is evaluated individually and the combined result is used to route the request<br>See [Hash Policy](#ring-hash-hash-policy) below.

#### Ring Hash Hash Policy

A [`hash_policy`](#ring-hash-hash-policy) block (within [`ring_hash`](#ring-hash)) supports the following:

<a id="ring-hash-hash-policy-cookie"></a>&#x2022; [`cookie`](#ring-hash-hash-policy-cookie) - Optional Block<br>Two types of cookie affinity: 1. Passive. Takes a cookie that's present in the cookies header and hashes on its value. 2. Generated. Generates and sets a cookie with an expiration (TTL) on the first request from the client in its response to the client, based on the endpoint the request gets<br>See [Cookie](#ring-hash-hash-policy-cookie) below.

<a id="ring-hash-hash-policy-header-name"></a>&#x2022; [`header_name`](#ring-hash-hash-policy-header-name) - Optional String<br>The name or key of the request header that will be used to obtain the hash key

<a id="ring-hash-hash-policy-source-ip"></a>&#x2022; [`source_ip`](#ring-hash-hash-policy-source-ip) - Optional Bool<br>Hash based on source IP address
...
<a id="httponly-54c45b"></a>&#x2022; [`add_httponly`](#httponly-54c45b) - Optional Block<br>Can be used for messages where no values are needed

<a id="ring-hash-hash-policy-cookie-add-secure"></a>&#x2022; [`add_secure`](#ring-hash-hash-policy-cookie-add-secure) - Optional Block<br>Can be used for messages where no values are needed

<a id="httponly-7f2aea"></a>&#x2022; [`ignore_httponly`](#httponly-7f2aea) - Optional Block<br>Can be used for messages where no values are needed

<a id="samesite-106140"></a>&#x2022; [`ignore_samesite`](#samesite-106140) - Optional Block<br>Can be used for messages where no values are needed

<a id="secure-febf51"></a>&#x2022; [`ignore_secure`](#secure-febf51) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="lax-749b7e"></a>&#x2022; [`samesite_lax`](#lax-749b7e) - Optional Block<br>Can be used for messages where no values are needed

<a id="none-5bbed3"></a>&#x2022; [`samesite_none`](#none-5bbed3) - Optional Block<br>Can be used for messages where no values are needed

<a id="strict-3e550d"></a>&#x2022; [`samesite_strict`](#strict-3e550d) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="routes-custom-route-object"></a>&#x2022; [`custom_route_object`](#routes-custom-route-object) - Optional Block<br>Custom route uses a route object created outside of this view<br>See [Custom Route Object](#routes-custom-route-object) below.

<a id="routes-direct-response-route"></a>&#x2022; [`direct_response_route`](#routes-direct-response-route) - Optional Block<br>Direct response route matches on path, incoming header, incoming port and/or HTTP method and responds directly to the matching traffic<br>See [Direct Response Route](#routes-direct-response-route) below.
...
<a id="name-82f318"></a>&#x2022; [`name`](#name-82f318) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="namespace-7ec6c4"></a>&#x2022; [`namespace`](#namespace-7ec6c4) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="tenant-a123ba"></a>&#x2022; [`tenant`](#tenant-a123ba) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="method-aec314"></a>&#x2022; [`http_method`](#method-aec314) - Optional String  Defaults to `ANY`<br>See [HTTP Methods](#common-http-methods)<br> Specifies the HTTP method used to access a resource. Any HTTP Method

<a id="port-9bcff1"></a>&#x2022; [`incoming_port`](#port-9bcff1) - Optional Block<br>Port match of the request can be a range or a specific port<br>See [Incoming Port](#port-9bcff1) below.

<a id="routes-direct-response-route-path"></a>&#x2022; [`path`](#routes-direct-response-route-path) - Optional Block<br>Path match of the URI can be either be, Prefix match or exact match or regular expression match<br>See [Path](#routes-direct-response-route-path) below.

<a id="response-d0dcbd"></a>&#x2022; [`route_direct_response`](#response-d0dcbd) - Optional Block<br>Send this direct response in case of route match action is direct response<br>See [Route Direct Response](#response-d0dcbd) below.
...
<a id="exact-23a9da"></a>&#x2022; [`exact`](#exact-23a9da) - Optional String<br>Header value to match exactly

<a id="match-16404c"></a>&#x2022; [`invert_match`](#match-16404c) - Optional Bool<br>Invert the result of the match to detect missing header or non-matching value

<a id="name-77fba0"></a>&#x2022; [`name`](#name-77fba0) - Optional String<br>Name. Name of the header

<a id="presence-72a565"></a>&#x2022; [`presence`](#presence-72a565) - Optional Bool<br>If true, check for presence of header

<a id="regex-4cdd3d"></a>&#x2022; [`regex`](#regex-4cdd3d) - Optional String<br>Regex match of the header value in re2 format
...
<a id="match-ba3425"></a>&#x2022; [`no_port_match`](#match-ba3425) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="routes-direct-response-route-path-path"></a>&#x2022; [`path`](#routes-direct-response-route-path-path) - Optional String<br>Exact path value to match

<a id="prefix-ff3976"></a>&#x2022; [`prefix`](#prefix-ff3976) - Optional String<br>Path prefix to match (e.g. The value / will match on all paths)

<a id="routes-direct-response-route-path-regex"></a>&#x2022; [`regex`](#routes-direct-response-route-path-regex) - Optional String<br>Regular expression of path match (e.g. The value .* will match on all paths)
...
<a id="routes-redirect-route-http-method"></a>&#x2022; [`http_method`](#routes-redirect-route-http-method) - Optional String  Defaults to `ANY`<br>See [HTTP Methods](#common-http-methods)<br> Specifies the HTTP method used to access a resource. Any HTTP Method

<a id="routes-redirect-route-incoming-port"></a>&#x2022; [`incoming_port`](#routes-redirect-route-incoming-port) - Optional Block<br>Port match of the request can be a range or a specific port<br>See [Incoming Port](#routes-redirect-route-incoming-port) below.

<a id="routes-redirect-route-path"></a>&#x2022; [`path`](#routes-redirect-route-path) - Optional Block<br>Path match of the URI can be either be, Prefix match or exact match or regular expression match<br>See [Path](#routes-redirect-route-path) below.

<a id="routes-redirect-route-route-redirect"></a>&#x2022; [`route_redirect`](#routes-redirect-route-route-redirect) - Optional Block<br>Route redirect parameters when match action is redirect<br>See [Route Redirect](#routes-redirect-route-route-redirect) below.
...
<a id="routes-redirect-route-headers-exact"></a>&#x2022; [`exact`](#routes-redirect-route-headers-exact) - Optional String<br>Header value to match exactly

<a id="match-b95584"></a>&#x2022; [`invert_match`](#match-b95584) - Optional Bool<br>Invert the result of the match to detect missing header or non-matching value
...
<a id="routes-redirect-route-headers-presence"></a>&#x2022; [`presence`](#routes-redirect-route-headers-presence) - Optional Bool<br>If true, check for presence of header

<a id="routes-redirect-route-headers-regex"></a>&#x2022; [`regex`](#routes-redirect-route-headers-regex) - Optional String<br>Regex match of the header value in re2 format
...
<a id="match-56f681"></a>&#x2022; [`no_port_match`](#match-56f681) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="routes-redirect-route-path-path"></a>&#x2022; [`path`](#routes-redirect-route-path-path) - Optional String<br>Exact path value to match

<a id="routes-redirect-route-path-prefix"></a>&#x2022; [`prefix`](#routes-redirect-route-path-prefix) - Optional String<br>Path prefix to match (e.g. The value / will match on all paths)

<a id="routes-redirect-route-path-regex"></a>&#x2022; [`regex`](#routes-redirect-route-path-regex) - Optional String<br>Regular expression of path match (e.g. The value .* will match on all paths)
...
<a id="redirect-bd044d"></a>&#x2022; [`host_redirect`](#redirect-bd044d) - Optional String<br>Swap host part of incoming URL in redirect URL

<a id="redirect-2ae47a"></a>&#x2022; [`path_redirect`](#redirect-2ae47a) - Optional String<br>swap path part of incoming URL in redirect URL
...
<a id="params-0941dc"></a>&#x2022; [`remove_all_params`](#params-0941dc) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="params-f96588"></a>&#x2022; [`retain_all_params`](#params-f96588) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="routes-simple-route-auto-host-rewrite"></a>&#x2022; [`auto_host_rewrite`](#routes-simple-route-auto-host-rewrite) - Optional Block<br>Can be used for messages where no values are needed

<a id="rewrite-706535"></a>&#x2022; [`disable_host_rewrite`](#rewrite-706535) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="routes-simple-route-host-rewrite"></a>&#x2022; [`host_rewrite`](#routes-simple-route-host-rewrite) - Optional String<br>Host header will be swapped with this value

<a id="routes-simple-route-http-method"></a>&#x2022; [`http_method`](#routes-simple-route-http-method) - Optional String  Defaults to `ANY`<br>See [HTTP Methods](#common-http-methods)<br> Specifies the HTTP method used to access a resource. Any HTTP Method

<a id="routes-simple-route-incoming-port"></a>&#x2022; [`incoming_port`](#routes-simple-route-incoming-port) - Optional Block<br>Port match of the request can be a range or a specific port<br>See [Incoming Port](#routes-simple-route-incoming-port) below.

<a id="routes-simple-route-origin-pools"></a>&#x2022; [`origin_pools`](#routes-simple-route-origin-pools) - Optional Block<br>Origin Pools for this route<br>See [Origin Pools](#routes-simple-route-origin-pools) below.

<a id="routes-simple-route-path"></a>&#x2022; [`path`](#routes-simple-route-path) - Optional Block<br>Path match of the URI can be either be, Prefix match or exact match or regular expression match<br>See [Path](#routes-simple-route-path) below.

<a id="routes-simple-route-query-params"></a>&#x2022; [`query_params`](#routes-simple-route-query-params) - Optional Block<br>Handling of incoming query parameters in simple route<br>See [Query Params](#routes-simple-route-query-params) below.
...
<a id="buffering-44c193"></a>&#x2022; [`common_buffering`](#buffering-44c193) - Optional Block<br>Can be used for messages where no values are needed

<a id="policy-b912b0"></a>&#x2022; [`common_hash_policy`](#policy-b912b0) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="policy-70b68a"></a>&#x2022; [`default_retry_policy`](#policy-70b68a) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="mirroring-e37294"></a>&#x2022; [`disable_mirroring`](#mirroring-e37294) - Optional Block<br>Can be used for messages where no values are needed

<a id="rewrite-8c52ee"></a>&#x2022; [`disable_prefix_rewrite`](#rewrite-8c52ee) - Optional Block<br>Can be used for messages where no values are needed

<a id="spdy-c4a11a"></a>&#x2022; [`disable_spdy`](#spdy-c4a11a) - Optional Block<br>Can be used for messages where no values are needed

<a id="waf-afaac0"></a>&#x2022; [`disable_waf`](#waf-afaac0) - Optional Block<br>Can be used for messages where no values are needed

<a id="config-b3faa9"></a>&#x2022; [`disable_web_socket_config`](#config-b3faa9) - Optional Block<br>Can be used for messages where no values are needed

<a id="cluster-f8e26f"></a>&#x2022; [`do_not_retract_cluster`](#cluster-f8e26f) - Optional Block<br>Can be used for messages where no values are needed

<a id="spdy-676c6f"></a>&#x2022; [`enable_spdy`](#spdy-676c6f) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="injection-46208e"></a>&#x2022; [`inherited_bot_defense_javascript_injection`](#injection-46208e) - Optional Block<br>Can be used for messages where no values are needed

<a id="waf-0043f0"></a>&#x2022; [`inherited_waf`](#waf-0043f0) - Optional Block<br>Can be used for messages where no values are needed

<a id="exclusion-0ba7d9"></a>&#x2022; [`inherited_waf_exclusion`](#exclusion-0ba7d9) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="policy-ad7b2b"></a>&#x2022; [`no_retry_policy`](#policy-ad7b2b) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="priority-f6c73d"></a>&#x2022; [`priority`](#priority-f6c73d) - Optional String  Defaults to `DEFAULT`<br>Possible values are `DEFAULT`, `HIGH`<br>[Enum: DEFAULT|HIGH] Priority routing for each request. Different connection pools are used based on the priority selected for the request. Also, circuit-breaker configuration at destination cluster is chosen based on selected priority

<a id="rewrite-c628a7"></a>&#x2022; [`regex_rewrite`](#rewrite-c628a7) - Optional Block<br>RegexMatchRewrite describes how to match a string and then produce a new string using a regular expression and a substitution string<br>See [Regex Rewrite](#rewrite-c628a7) below.

<a id="add-818453"></a>&#x2022; [`request_cookies_to_add`](#add-818453) - Optional Block<br>Cookies are key-value pairs to be added to HTTP request being routed towards upstream. Cookies specified at this level are applied after cookies from matched Route are applied<br>See [Request Cookies To Add](#add-818453) below.

<a id="remove-8d3e2e"></a>&#x2022; [`request_cookies_to_remove`](#remove-8d3e2e) - Optional List<br>List of keys of Cookies to be removed from the HTTP request being sent towards upstream

<a id="add-b0a13c"></a>&#x2022; [`request_headers_to_add`](#add-b0a13c) - Optional Block<br>Headers are key-value pairs to be added to HTTP request being routed towards upstream<br>See [Request Headers To Add](#add-b0a13c) below.

<a id="remove-68d81f"></a>&#x2022; [`request_headers_to_remove`](#remove-68d81f) - Optional List<br>List of keys of Headers to be removed from the HTTP request being sent towards upstream

<a id="add-b87fc7"></a>&#x2022; [`response_cookies_to_add`](#add-b87fc7) - Optional Block<br>Cookies are name-value pairs along with optional attribute parameters to be added to HTTP response being sent towards downstream. Cookies specified at this level are applied after cookies from matched Route are applied<br>See [Response Cookies To Add](#add-b87fc7) below.

<a id="remove-e3e521"></a>&#x2022; [`response_cookies_to_remove`](#remove-e3e521) - Optional List<br>List of name of Cookies to be removed from the HTTP response being sent towards downstream. Entire set-cookie header will be removed

<a id="add-9fbd2a"></a>&#x2022; [`response_headers_to_add`](#add-9fbd2a) - Optional Block<br>Headers are key-value pairs to be added to HTTP response being sent towards downstream<br>See [Response Headers To Add](#add-9fbd2a) below.
...
<a id="cluster-3cb556"></a>&#x2022; [`retract_cluster`](#cluster-3cb556) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="timeout-57487b"></a>&#x2022; [`timeout`](#timeout-57487b) - Optional Number<br>The timeout for the route including all retries, in milliseconds. Should be set to a high value or 0 (infinite timeout) for server-side streaming

<a id="policy-4e9c59"></a>&#x2022; [`waf_exclusion_policy`](#policy-4e9c59) - Optional Block<br>Type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [WAF Exclusion Policy](#policy-4e9c59) below.

<a id="config-8876be"></a>&#x2022; [`web_socket_config`](#config-8876be) - Optional Block<br>Configuration to allow WebSocket Request headers of such upgrade looks like below 'connection', 'Upgrade' 'upgrade', 'WebSocket' With configuration to allow WebSocket upgrade, ADC will produce following response 'HTTP/1.1 101 Switching Protocols 'Upgrade': 'WebSocket' 'Connection': 'Upgrade'<br>See [Web Socket Config](#config-8876be) below.
...
<a id="name-dd1197"></a>&#x2022; [`name`](#name-dd1197) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="namespace-118663"></a>&#x2022; [`namespace`](#namespace-118663) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="tenant-6ccea5"></a>&#x2022; [`tenant`](#tenant-6ccea5) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="disabled-8985b5"></a>&#x2022; [`disabled`](#disabled-8985b5) - Optional Bool<br>Disable buffering for a particular route. This is useful when virtual-host has buffering, but we need to disable it on a specific route. The value of this field is ignored for virtual-host
...
<a id="credentials-5c92f8"></a>&#x2022; [`allow_credentials`](#credentials-5c92f8) - Optional Bool<br>Specifies whether the resource allows credentials

<a id="headers-706468"></a>&#x2022; [`allow_headers`](#headers-706468) - Optional String<br>Specifies the content for the access-control-allow-headers header

<a id="methods-8c987d"></a>&#x2022; [`allow_methods`](#methods-8c987d) - Optional String<br>Specifies the content for the access-control-allow-methods header

<a id="origin-fbf2bc"></a>&#x2022; [`allow_origin`](#origin-fbf2bc) - Optional List<br>Specifies the origins that will be allowed to do CORS requests. An origin is allowed if either allow_origin or allow_origin_regex match

<a id="regex-0641e8"></a>&#x2022; [`allow_origin_regex`](#regex-0641e8) - Optional List<br>Specifies regex patterns that match allowed origins. An origin is allowed if either allow_origin or allow_origin_regex match

<a id="disabled-cd4fb6"></a>&#x2022; [`disabled`](#disabled-cd4fb6) - Optional Bool<br>Disable the CorsPolicy for a particular route. This is useful when virtual-host has CorsPolicy, but we need to disable it on a specific route. The value of this field is ignored for virtual-host

<a id="headers-c03d50"></a>&#x2022; [`expose_headers`](#headers-c03d50) - Optional String<br>Specifies the content for the access-control-expose-headers header

<a id="age-eabbcc"></a>&#x2022; [`maximum_age`](#age-eabbcc) - Optional Number<br>Specifies the content for the access-control-max-age header in seconds. This indicates the maximum number of seconds the results can be cached A value of -1 will disable caching. Maximum permitted value is 86400 seconds (24 hours)
...
<a id="domains-b58044"></a>&#x2022; [`all_load_balancer_domains`](#domains-b58044) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="disabled-ac6077"></a>&#x2022; [`disabled`](#disabled-ac6077) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="pool-8c75a0"></a>&#x2022; [`origin_pool`](#pool-8c75a0) - Optional Block<br>Type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [Origin Pool](#pool-8c75a0) below.

<a id="percent-99590a"></a>&#x2022; [`percent`](#percent-99590a) - Optional Block<br>Fraction used where sampling percentages are needed. Example sampled requests<br>See [Percent](#percent-99590a) below.
...
<a id="pattern-191576"></a>&#x2022; [`pattern`](#pattern-191576) - Optional String<br>The regular expression used to find portions of a string that should be replaced

<a id="substitution-55c137"></a>&#x2022; [`substitution`](#substitution-55c137) - Optional String<br>The string that should be substituted into matching portions of the subject string during a substitution operation to produce a new string
...
<a id="off-e4369f"></a>&#x2022; [`back_off`](#off-e4369f) - Optional Block<br>Specifies parameters that control retry back off<br>See [Back Off](#off-e4369f) below.

<a id="retries-ee7703"></a>&#x2022; [`num_retries`](#retries-ee7703) - Optional Number  Defaults to `1`<br>Specifies the allowed number of retries. Retries can be done any number of times. An exponential back-off algorithm is used between each retry

<a id="timeout-2485fd"></a>&#x2022; [`per_try_timeout`](#timeout-2485fd) - Optional Number<br>Specifies a non-zero timeout per retry attempt. In milliseconds

<a id="codes-110133"></a>&#x2022; [`retriable_status_codes`](#codes-110133) - Optional List<br>HTTP status codes that should trigger a retry in addition to those specified by retry_on

<a id="condition-28432a"></a>&#x2022; [`retry_condition`](#condition-28432a) - Optional List<br>Specifies the conditions under which retry takes place. Retries can be on different types of condition depending on application requirements. For example, network failure, all 5xx response codes, idempotent 4xx response codes, etc The possible values are '5xx' : Retry will be done if the
...
<a id="routes-simple-route-headers-exact"></a>&#x2022; [`exact`](#routes-simple-route-headers-exact) - Optional String<br>Header value to match exactly

<a id="match-29c396"></a>&#x2022; [`invert_match`](#match-29c396) - Optional Bool<br>Invert the result of the match to detect missing header or non-matching value

<a id="routes-simple-route-headers-name"></a>&#x2022; [`name`](#routes-simple-route-headers-name) - Optional String<br>Name. Name of the header

<a id="routes-simple-route-headers-presence"></a>&#x2022; [`presence`](#routes-simple-route-headers-presence) - Optional Bool<br>If true, check for presence of header

<a id="routes-simple-route-headers-regex"></a>&#x2022; [`regex`](#routes-simple-route-headers-regex) - Optional String<br>Regex match of the header value in re2 format
...
<a id="match-80b1e5"></a>&#x2022; [`no_port_match`](#match-80b1e5) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="priority-b8cd45"></a>&#x2022; [`priority`](#priority-b8cd45) - Optional Number<br>Priority of this origin pool, valid only with multiple origin pools. Value of 0 will make the pool as lowest priority origin pool Priority of 1 means highest priority and is considered active. When active origin pool is not available, lower priority origin pools are made active as per the

<a id="routes-simple-route-origin-pools-weight"></a>&#x2022; [`weight`](#routes-simple-route-origin-pools-weight) - Optional Number<br>Weight of this origin pool, valid only with multiple origin pool. Value of 0 will disable the pool
...
<a id="name-82cffb"></a>&#x2022; [`name`](#name-82cffb) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="namespace-b73e1d"></a>&#x2022; [`namespace`](#namespace-b73e1d) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="tenant-511970"></a>&#x2022; [`tenant`](#tenant-511970) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="name-7e0a9d"></a>&#x2022; [`name`](#name-7e0a9d) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then name will hold the referred object's(e.g. Route's) name

<a id="namespace-f2152d"></a>&#x2022; [`namespace`](#namespace-f2152d) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then namespace will hold the referred object's(e.g. Route's) namespace

<a id="tenant-06f782"></a>&#x2022; [`tenant`](#tenant-06f782) - Optional String<br>When a configuration object(e.g. Virtual_host) refers to another(e.g route) then tenant will hold the referred object's(e.g. Route's) tenant
...
<a id="routes-simple-route-path-path"></a>&#x2022; [`path`](#routes-simple-route-path-path) - Optional String<br>Exact path value to match

<a id="routes-simple-route-path-prefix"></a>&#x2022; [`prefix`](#routes-simple-route-path-prefix) - Optional String<br>Path prefix to match (e.g. The value / will match on all paths)

<a id="routes-simple-route-path-regex"></a>&#x2022; [`regex`](#routes-simple-route-path-regex) - Optional String<br>Regular expression of path match (e.g. The value .* will match on all paths)
...
<a id="params-aa1f17"></a>&#x2022; [`remove_all_params`](#params-aa1f17) - Optional Block<br>Can be used for messages where no values are needed

<a id="params-c3e5f1"></a>&#x2022; [`replace_params`](#params-c3e5f1) - Optional String

<a id="params-bd2237"></a>&#x2022; [`retain_all_params`](#params-bd2237) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="response-2680e4"></a>&#x2022; [`sensitive_data_types_in_response`](#response-2680e4) - Optional Block<br>Sensitive Data Exposure Rules allows specifying rules to mask sensitive data fields in API responses<br>See [Sensitive Data Types In Response](#response-2680e4) below.
...
<a id="single-lb-app-disable-discovery"></a>&#x2022; [`disable_discovery`](#single-lb-app-disable-discovery) - Optional Block<br>Can be used for messages where no values are needed

<a id="detection-d482d0"></a>&#x2022; [`disable_malicious_user_detection`](#detection-d482d0) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="detection-280554"></a>&#x2022; [`enable_malicious_user_detection`](#detection-280554) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="discovery-e02c6d"></a>&#x2022; [`default_api_auth_discovery`](#discovery-e02c6d) - Optional Block<br>Can be used for messages where no values are needed

<a id="traffic-7e1631"></a>&#x2022; [`disable_learn_from_redirect_traffic`](#traffic-7e1631) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="traffic-ebfb24"></a>&#x2022; [`enable_learn_from_redirect_traffic`](#traffic-ebfb24) - Optional Block<br>Can be used for messages where no values are needed
...
<a id="crawler-f73dfe"></a>&#x2022; [`disable_api_crawler`](#crawler-f73dfe) - Optional Block<br>Can be used for messages where no values are needed
