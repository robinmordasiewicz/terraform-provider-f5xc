...
&#x2022; `name` - Required String<br>Name of the InfraprotectAsn. Must be unique within the namespace

&#x2022; `namespace` - Required String<br>Namespace where the InfraprotectAsn will be created
...
&#x2022; `asn` - Optional Number<br>ASN. 2-byte or 4-byte Autonomous System Number (ASN)
