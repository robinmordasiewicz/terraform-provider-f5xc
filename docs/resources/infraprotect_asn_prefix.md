...
&#x2022; `name` - Required String<br>Name of the InfraprotectAsnPrefix. Must be unique within the namespace

&#x2022; `namespace` - Required String<br>Namespace where the InfraprotectAsnPrefix will be created
...
&#x2022; `asn` - Optional Block<br>Object reference. This type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [Asn](#asn) below for details.
