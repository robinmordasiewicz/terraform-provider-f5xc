...
&#x2022; [`name`](#name) - Required String<br>Name of the InfraprotectDenyListRule. Must be unique within the namespace

&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the InfraprotectDenyListRule will be created
...
&#x2022; [`expiration_never`](#expiration-never) - Optional Block<br>Empty. This can be used for messages where no values are needed
<br><br>&#x2022; [`expiration_timestamp`](#expiration-timestamp) - Optional String<br>Expiration Time (UTC). This deny list rule will expire at the given timestamp and will be removed from the system afterwards
<br><br>&#x2022; [`one_day`](#one-day) - Optional Block<br>Empty. This can be used for messages where no values are needed
<br><br>&#x2022; [`one_hour`](#one-hour) - Optional Block<br>Empty. This can be used for messages where no values are needed
<br><br>&#x2022; [`one_month`](#one-month) - Optional Block<br>Empty. This can be used for messages where no values are needed
<br><br>&#x2022; [`one_year`](#one-year) - Optional Block<br>Empty. This can be used for messages where no values are needed
