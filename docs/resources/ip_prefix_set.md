...
&#x2022; `name` - Required String<br>Name of the IPPrefixSet. Must be unique within the namespace

&#x2022; `namespace` - Required String<br>Namespace where the IPPrefixSet will be created
...
&#x2022; `ipv4_prefixes` - Optional Block<br>IPv4 Prefixes. list of IPv4 prefixes with description<br>See [IPv4 Prefixes](#ipv4-prefixes) below for details.
...
&#x2022; `description` - Optional String<br>Description

&#x2022; `ipv4_prefix` - Optional String<br>IPv4 Prefix
