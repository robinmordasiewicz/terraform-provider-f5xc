...
<a id="name"></a>&#x2022; [`name`](#name) - Required String<br>Name of the IP Prefix Set. Must be unique within the namespace

<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the IP Prefix Set will be created
...
<a id="ipv4-prefixes-description-spec"></a>&#x2022; [`description_spec`](#ipv4-prefixes-description-spec) - Optional String<br>Description
