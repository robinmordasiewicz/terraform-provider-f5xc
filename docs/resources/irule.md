...
&#x2022; `name` - Required String<br>Name of the Irule. Must be unique within the namespace

&#x2022; `namespace` - Required String<br>Namespace where the Irule will be created
...
&#x2022; `description` - Optional String<br>Description for iRule. Specify Description for iRule
...
&#x2022; `irule` - Optional String<br>irule. x-example: 'when DNS_REQUEST { if {([string tolower [DNS::question name]] equals '`www.internal.example.f5.com'`)} DNS::drop} irule content
