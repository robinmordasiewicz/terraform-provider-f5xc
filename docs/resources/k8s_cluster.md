...
-> **Note:** Only one of the following may be set: `cluster_scoped_access_deny`, `cluster_scoped_access_permit`
...
-> **Note:** Only one of the following may be set: `cluster_wide_app_list`, `no_cluster_wide_apps`
...
-> **Note:** Only one of the following may be set: `global_access_enable`, `no_global_access`
...
-> **Note:** Only one of the following may be set: `insecure_registry_list`, `no_insecure_registries`
...
-> **Note:** Only one of the following may be set: `local_access_config`, `no_local_access`
...
-> **Note:** Only one of the following may be set: `use_custom_cluster_role_bindings`, `use_default_cluster_role_bindings`
...
-> **Note:** Only one of the following may be set: `use_custom_cluster_role_list`, `use_default_cluster_roles`
...
-> **Note:** Only one of the following may be set: `use_custom_pod_security_admission`, `use_default_pod_security_admission`
...
-> **Note:** Only one of the following may be set: `use_custom_psp_list`, `use_default_psp`
...
-> **Note:** Only one of the following may be set: `vk8s_namespace_access_deny`, `vk8s_namespace_access_permit`
