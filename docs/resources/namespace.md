...
&#x2022; `name` - Required String<br>Name of the Namespace. Must be unique within the namespace

&#x2022; `namespace` - Required String<br>Namespace where the Namespace will be created
