...
-> **Note:** Only one of the following may be set: `disable_forward_proxy`, `enable_forward_proxy`
...
-> **Note:** Only one of the following may be set: `sli_to_global_dr`, `sli_to_slo_snat`, `slo_to_global_dr`
