...
- `egress_rules` (Block List) Egress Rules. Ordered list of rules applied to connections from policy endpoints. (see [below for nested schema](#nestedblock--rules--egress_rules))
- `ingress_rules` (Block List) Ingress Rules. Ordered list of rules applied to connections to policy endpoints. (see [below for nested schema](#nestedblock--rules--ingress_rules))
...
- `ref` (Block List) Reference. A list of references to ip_prefix_set objects. (see [below for nested schema](#nestedblock--rules--egress_rules--ip_prefix_set--ref))
...
- `ref` (Block List) Reference. A list of references to ip_prefix_set objects. (see [below for nested schema](#nestedblock--rules--ingress_rules--ip_prefix_set--ref))
