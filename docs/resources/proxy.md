...
-> **Note:** Only one of the following may be set: `active_forward_proxy_policies`, `no_forward_proxy_policy`
...
-> **Note:** Only one of the following may be set: `do_not_advertise`, `site_virtual_sites`
...
-> **Note:** Only one of the following may be set: `dynamic_proxy`, `http_proxy`
...
-> **Note:** Only one of the following may be set: `no_interception`, `tls_intercept`
...
-> **Note:** Only one of the following may be set: `site_local_inside_network`, `site_local_network`
