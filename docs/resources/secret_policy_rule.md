...
&#x2022; `name` - Required String<br>Name of the SecretPolicyRule. Must be unique within the namespace

&#x2022; `namespace` - Required String<br>Namespace where the SecretPolicyRule will be created
