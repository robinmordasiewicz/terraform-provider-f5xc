...
-> **Note:** Only one of the following may be set: `active_enhanced_firewall_policies`, `no_network_policy`
...
-> **Note:** Only one of the following may be set: `active_forward_proxy_policies`, `no_forward_proxy`
...
-> **Note:** Only one of the following may be set: `aws`, `azure`, `baremetal`, `equinix`, `gcp`, `kvm`, `nutanix`, `oci`, `openstack`, `vmware`
...
-> **Note:** Only one of the following may be set: `block_all_services`, `blocked_services`
...
-> **Note:** Only one of the following may be set: `custom_proxy`, `f5_proxy`
...
-> **Note:** Only one of the following may be set: `custom_proxy_bypass`, `no_proxy_bypass`
...
-> **Note:** Only one of the following may be set: `dc_cluster_group_sli`, `no_s2s_connectivity_sli`
...
-> **Note:** Only one of the following may be set: `dc_cluster_group_slo`, `no_s2s_connectivity_slo`, `site_mesh_group_on_slo`
...
-> **Note:** Only one of the following may be set: `disable_ha`, `enable_ha`
...
-> **Note:** Only one of the following may be set: `disable_url_categorization`, `enable_url_categorization`
