...
&#x2022; [`name`](#name) - Required String<br>Name of the Token. Must be unique within the namespace

&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the Token will be created
