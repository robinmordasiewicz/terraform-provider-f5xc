...
&#x2022; `name` - Required String<br>Name of the TpmManager. Must be unique within the namespace

&#x2022; `namespace` - Required String<br>Namespace where the TpmManager will be created
