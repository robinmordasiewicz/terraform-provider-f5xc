...
&#x2022; `name` - Required String<br>Name of the TrustedCaList. Must be unique within the namespace

&#x2022; `namespace` - Required String<br>Namespace where the TrustedCaList will be created
...
&#x2022; `trusted_ca_url` - Optional String<br>Root CA Certificate. Trusted CA certificates for validating certificates
