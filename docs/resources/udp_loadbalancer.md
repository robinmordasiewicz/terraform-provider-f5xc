...
<a id="name"></a>&#x2022; [`name`](#name) - Required String<br>Name of the UDPLoadBalancer. Must be unique within the namespace

<a id="namespace"></a>&#x2022; [`namespace`](#namespace) - Required String<br>Namespace where the UDPLoadBalancer will be created
