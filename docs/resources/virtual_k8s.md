...
&#x2022; `name` - Required String<br>Name of the VirtualK8S. Must be unique within the namespace

&#x2022; `namespace` - Required String<br>Namespace where the VirtualK8S will be created
...
&#x2022; `default_flavor_ref` - Optional Block<br>Object reference. This type establishes a direct reference from one object(the referrer) to another(the referred). Such a reference is in form of tenant/namespace/name<br>See [Default Flavor Ref](#default-flavor-ref) below for details.
