...
`master_node_configuration` - (Optional) Master Nodes. Configuration of master nodes Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.repeated.max_items: 3. See [Master Node Configuration](#master-node-configuration) below for details.
...
`volterra_certified_hw` - (Optional) Generic Server Certified Hardware. Name for generic server certified hardware to form this App Stack site. Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.string (`String`).

`worker_nodes` - (Optional) Worker Nodes. Names of worker nodes ves.io.schema.rules.repeated.max_items: 128 ves.io.schema.rules.repeated.unique: true (`List`).
...
`bgp_router_id` - (Optional) BGP Router ID. Optional bgp router id that can be used as parameter for BGP configuration when BGP is configured to fetch BGP router ID from site object. ves.io.schema.rules.string.ip: true (`String`).
...
`outside_nameserver` - (Optional) DNS V4 Server for Local Network. Optional DNS server V4 IP to be used for name resolution in local network ves.io.schema.rules.string.ipv4: true (`String`).

`outside_vip` - (Optional) Common V4 VIP. Optional common virtual V4 IP across all nodes to be used as automatic VIP for site local network. ves.io.schema.rules.string.ipv4: true (`String`).

`site_to_site_tunnel_ip` - (Optional) Site Mesh Group Connection Via Virtual Ip. Exclusive with [sm_connection_public_ip sm_connection_pvt_ip] Site Mesh Group Connection Via Virtual IP (`String`).
...
`interfaces` - (Optional) List of Interface. Configure network interfaces for this App Stack site Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.repeated.max_items: 128 ves.io.schema.rules. See [Interfaces](#nestedblock--custom_network_config--interface_list--interfaces) below.
...
`description` - (Optional) Interface Description. Description for this Interface ves.io.schema.rules.string.max_len: 256 (`String`).
...
`static_routes` - (Optional) Static Routes. List of static routes Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.repeated.max_items: 16 ves.io.schema.rules.repeated.min_items: 1 ves.io.schema.rules. See [Static Routes](#nestedblock--custom_network_config--sli_config--static_routes--static_routes) below.
...
`static_routes` - (Optional) Static Routes. List of static routes Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.repeated.max_items: 16 ves.io.schema.rules.repeated.min_items: 1 ves.io.schema.rules. See [Static Routes](#nestedblock--custom_network_config--slo_config--static_routes--static_routes) below.
...
`static_routes` - (Optional) Static IPv6 Routes. List of IPv6 static routes Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.repeated.max_items: 16 ves.io.schema.rules.repeated.min_items: 1 ves.io. See [Static Routes](#nestedblock--custom_network_config--slo_config--static_v6_routes--static_routes) below.
...
`static_routes` - (Optional) Static Routes. List of static routes Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.repeated.max_items: 16 ves.io.schema.rules.repeated.min_items: 1 ves.io.schema.rules. See [Static Routes](#nestedblock--custom_storage_config--static_routes--static_routes) below.
...
`storage_classes` - (Optional) List of Storage Classes. List of custom storage classes ves.io.schema.rules.repeated.max_items: 4 ves.io.schema.rules.repeated.unique: true. See [Storage Classes](#nestedblock--custom_storage_config--storage_class_list--storage_classes) below.
...
`advanced_storage_parameters` - (Optional) Advanced Parameters. Map of parameter name and string value ves.io.schema.rules.map.keys.string.max_len: 128 ves.io.schema.rules.map.keys.string.min_len: 1 ves.io.schema.rules.map.max_pairs: 64 ves. See [Advanced Storage Parameters](#nestedblock--custom_storage_config--storage_class_list--storage_classes--advanced_storage_parameters) below.
...
`storage_devices` - (Optional) List of Storage Devices. List of custom storage devices ves.io.schema.rules.repeated.max_items: 4 ves.io.schema.rules.repeated.unique: true. See [Storage Devices](#nestedblock--custom_storage_config--storage_device_list--storage_devices) below.
...
`advanced_advanced_parameters` - (Optional) Advanced Parameters. Map of parameter name and string value ves.io.schema.rules.map.keys.string.max_len: 128 ves.io.schema.rules.map.keys.string.min_len: 1 ves.io.schema.rules.map.max_pairs: 64 ves. See [Advanced Advanced Parameters](#nestedblock--custom_storage_config--storage_device_list--storage_devices--advanced_advanced_parameters) below.
...
`storage_interfaces` - (Optional) List of Interface. Configure storage interfaces for this App Stack site Required: YES ves.io.schema.rules.message.required: true ves.io.schema.rules.repeated.max_items: 256 ves.io.schema.rules. See [Storage Interfaces](#nestedblock--custom_storage_config--storage_interface_list--storage_interfaces) below.
...
`peers` - (Optional) Peers. BGP parameters for peer ves.io.schema.rules.repeated.max_items: 8 ves.io.schema.rules.repeated.unique_metadata_name: true. See [Peers](#nestedblock--local_control_plane--bgp_config--peers) below.
...
`name` - (Optional) Name. Names of master node Required: YES ves.io.schema.rules.message.required: true (`String`).

`public_ip` - (Optional) Public IP. IP Address of the master node. This ip will be used when other sites connect via Site Mesh Group ves.io.schema.rules.string.ipv4: true (`String`).
