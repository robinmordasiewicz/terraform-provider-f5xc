...
var (
	_ datasource.DataSource              = &APICredentialDataSource{}
	_ datasource.DataSourceWithConfigure = &APICredentialDataSource{}
)
	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				MarkdownDescription: "Name of the APICredential.",
				Required:            true,
			},
			"namespace": schema.StringAttribute{
				MarkdownDescription: "Namespace where the APICredential exists.",
				Required:            true,
			},
			"description": schema.StringAttribute{
				MarkdownDescription: "Description of the APICredential.",
				Computed:            true,
			},
...
func (d *APICredentialDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	resource, err := d.client.GetAPICredential(ctx, data.Namespace.ValueString(), data.Name.ValueString())
	if err != nil {
