	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateIdFunc:       testAccAPITestingImportStateIdFunc(resourceName),
			},
		},
	})
}

func testAccAPITestingImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
