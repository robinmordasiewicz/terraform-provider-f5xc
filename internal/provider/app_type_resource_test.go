	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateIdFunc:       testAccAppTypeImportStateIdFunc(resourceName),
			},
		},
	})
}

func testAccAppTypeImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
func testAccAppTypeConfig_basic(nsName, name string) string {
