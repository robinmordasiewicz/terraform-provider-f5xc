...
func TestAccAWSVPCSiteResource_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateIdFunc:       testAccAWSVPCSiteImportStateIdFunc(resourceName),
			},
		},
	})
}

func testAccAWSVPCSiteImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
func testAccAWSVPCSiteConfig_basic(nsName, name string) string {
...
# - aws_region
# - vpc_id or new VPC configuration
# - AWS credentials
