...
var (
	_ datasource.DataSource              = &BGPAsnSetDataSource{}
	_ datasource.DataSourceWithConfigure = &BGPAsnSetDataSource{}
)

func NewBGPAsnSetDataSource() datasource.DataSource {
	return &BGPAsnSetDataSource{}
}

type BGPAsnSetDataSource struct {
	client *client.Client
}

type BGPAsnSetDataSourceModel struct {
...
func (d *BGPAsnSetDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"namespace": schema.StringAttribute{
				MarkdownDescription: "Namespace where the BGPAsnSet exists.",
				Required:            true,
			},
...
func (d *BGPAsnSetDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *BGPAsnSetDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data BGPAsnSetDataSourceModel
