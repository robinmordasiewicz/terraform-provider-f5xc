...
var (
	_ datasource.DataSource              = &CertificateChainDataSource{}
	_ datasource.DataSourceWithConfigure = &CertificateChainDataSource{}
)

func NewCertificateChainDataSource() datasource.DataSource {
	return &CertificateChainDataSource{}
}

type CertificateChainDataSource struct {
...
func (d *CertificateChainDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"namespace": schema.StringAttribute{
				MarkdownDescription: "Namespace where the CertificateChain exists.",
				Required:            true,
			},
...
func (d *CertificateChainDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *CertificateChainDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data CertificateChainDataSourceModel
