...
var (
	_ datasource.DataSource              = &DcClusterGroupDataSource{}
	_ datasource.DataSourceWithConfigure = &DcClusterGroupDataSource{}
)

func NewDcClusterGroupDataSource() datasource.DataSource {
	return &DcClusterGroupDataSource{}
}

type DcClusterGroupDataSource struct {
...
func (d *DcClusterGroupDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *DcClusterGroupDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *DcClusterGroupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data DcClusterGroupDataSourceModel
