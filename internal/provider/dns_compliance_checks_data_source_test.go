...
func TestAccDnsComplianceChecksDataSource_basic(t *testing.T) {
	...
	dataSourceName := "data.f5xc_dns_compliance_checks.test"
...
data "f5xc_dns_compliance_checks" "test" {
  depends_on = [f5xc_dns_compliance_checks.test]
  name       = f5xc_dns_compliance_checks.test.name
  namespace  = f5xc_dns_compliance_checks.test.namespace
}
`, nsName, name))
}
