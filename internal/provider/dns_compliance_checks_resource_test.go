	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateIdFunc:       testAccDNSComplianceChecksImportStateIdFunc(resourceName),
			},
		},
	})
}

func testAccDNSComplianceChecksImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
func testAccDNSComplianceChecksConfig_basic(nsName, name string) string {
