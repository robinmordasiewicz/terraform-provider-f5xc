	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"timeouts", "action", "ip_prefix_set"},
				ImportStateIdFunc:       testAccFastACLRuleImportStateIdFunc(resourceName),
			},
		},
	})
}

func testAccFastACLRuleImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
func testAccFastACLRuleConfig_basic(nsName, name string) string {
