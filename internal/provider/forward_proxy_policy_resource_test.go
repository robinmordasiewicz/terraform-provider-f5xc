	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateIdFunc:       testAccForwardProxyPolicyImportStateIdFunc(resourceName),
			},
		},
	})
}

func testAccForwardProxyPolicyImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
func testAccForwardProxyPolicyConfig_basic(nsName, name string) string {
