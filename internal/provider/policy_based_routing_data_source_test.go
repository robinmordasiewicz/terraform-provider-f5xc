...
func TestAccPolicyBasedRoutingDataSource_basic(t *testing.T) {
	...
	dataSourceName := "data.f5xc_policy_based_routing.test"
...
data "f5xc_policy_based_routing" "test" {
  depends_on = [f5xc_policy_based_routing.test]
  name       = f5xc_policy_based_routing.test.name
  namespace  = f5xc_policy_based_routing.test.namespace
}
`, nsName, name))
}
