	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateIdFunc:       testAccProxyImportStateIdFunc(resourceName),
			},
		},
	})
}

func testAccProxyImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
func testAccProxyConfig_basic(nsName, name string) string {
