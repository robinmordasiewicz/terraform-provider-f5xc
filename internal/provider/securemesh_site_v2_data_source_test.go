...
func TestAccSecuremeshSiteV2DataSource_basic(t *testing.T) {
	...
	dataSourceName := "data.f5xc_securemesh_site_v2.test"
...
data "f5xc_securemesh_site_v2" "test" {
  depends_on = [f5xc_securemesh_site_v2.test]
  name       = f5xc_securemesh_site_v2.test.name
  namespace  = f5xc_securemesh_site_v2.test.namespace
}
`, nsName, name))
}
