...
// =============================================================================
// TPM CATEGORY RESOURCE ACCEPTANCE TESTS
//
...
//   go test -v ./internal/provider/ -run TestAccTpmCategoryResource -timeout 30m
// =============================================================================
...
func TestAccTpmCategoryResource_basic(t *testing.T) {
	...
	resourceName := "f5xc_tpm_category.test"
	nsName := acctest.RandomName("tf-acc-test-ns")
	name := acctest.RandomName("tf-acc-test-tpm-cat")
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Create tpm_category with minimal configuration
			{
				Config: testAccTpmCategoryResourceConfig_basic(nsName, name),
			...
			// Step 2: Import state verification
			{
				...
				ImportStateIdFunc: testAccTpmCategoryResourceImportStateIdFunc(resourceName),
...
func testAccTpmCategoryResourceImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
func testAccTpmCategoryResourceConfig_basic(nsName, name string) string {
...
resource "f5xc_tpm_category" "test" {
