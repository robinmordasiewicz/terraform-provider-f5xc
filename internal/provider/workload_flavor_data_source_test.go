...
func TestAccWorkloadFlavorDataSource_basic(t *testing.T) {
	...
	dataSourceName := "data.f5xc_workload_flavor.test"
...
data "f5xc_workload_flavor" "test" {
  depends_on = [f5xc_workload_flavor.test]
  name       = f5xc_workload_flavor.test.name
  namespace  = f5xc_workload_flavor.test.namespace
}
`, nsName, name))
}
