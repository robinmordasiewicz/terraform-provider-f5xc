...
GENERATED_PATTERNS=(
    # Provider documentation - generated by tfplugindocs + transform-docs.go (docs.yml)
    "^docs/resources/.*\.md$"
    "^docs/data-sources/.*\.md$"
    # API documentation - generated by generate-api-docs.go (pages.yml)
    "^docs/api/.*\.md$"
    "^docs/nav-api\.yml$"
    # MkDocs site build output - generated by mkdocs build (pages.yml)
    "^site/"
    # Provider Go code - generated by generate-all-schemas.go (generate.yml)
    "^internal/provider/.*_resource\.go$"
    "^internal/provider/.*_data_source\.go$"
    # Example Terraform files - generated by generate-examples.go (docs.yml)
...
if [ ${#VIOLATIONS[@]} -gt 0 ]; then
    echo -e "${RED}❌ ERROR: Attempting to commit generated files${NC}"
    echo -e "${YELLOW}"
